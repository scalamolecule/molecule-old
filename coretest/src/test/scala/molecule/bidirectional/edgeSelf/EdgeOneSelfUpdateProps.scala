...
class EdgeOneSelfUpdateProps extends MoleculeSpec {
  ...
  "Card-one" >> {
    ...
    "value" in new Setup {
      ...
      living_Person.name("Ann" or "Ben").Loves.weight.get.sortBy(_._1) === List(
        ("Ann", 7),
        ("Ben", 7)
      )

      // Apply new value
      living_Loves(annBen).weight(2).update
      living_Person.name("Ann" or "Ben").Loves.weight.get.sortBy(_._1) === List(
        ("Ann", 2),
        ("Ben", 2)
      )
      ...
      // Retract value
      living_Loves(annBen).weight().update
      living_Person.name("Ann" or "Ben").Loves.weight.get === List()
    }
    ...
    "enum" in new Setup {
      ...
      living_Person.name("Ann" or "Ben").Loves.howWeMet.get.sortBy(_._1) === List(
        ("Ann", "atWork"),
        ("Ben", "atWork")
      )

      // Apply new enum value
      living_Loves(annBen).howWeMet("throughFriend").update
      living_Person.name("Ann" or "Ben").Loves.howWeMet.get.sortBy(_._1) === List(
        ("Ann", "throughFriend"),
        ("Ben", "throughFriend")
      )
      ...
      // Retract enum value
      living_Loves(annBen).howWeMet().update
      living_Person.name("Ann" or "Ben").Loves.howWeMet.get === List()
    }
    ...
    "ref" in new Setup {
      ...
      // Current value
      living_Person.name("Ann" or "Ben").Loves.CoreQuality.name.get.sortBy(_._1) === List(
        ("Ann", "Love"),
        ("Ben", "Love")
      )

      // We can't update across namespaces
      (living_Loves(annBen).CoreQuality.name("Compassion").update must throwA[IllegalArgumentException])
        .message === "Got the exception java.lang.IllegalArgumentException: " +
      ...
      living_Loves(annBen).coreQuality(trust).update
      ...
      // Retract reference
      living_Loves(annBen).coreQuality().update
      living_Loves(annBen).CoreQuality.name.get === List()
    }
  }
  ...
  "Card-many" >> {
    ...
    "values" in new Setup {
      ...
      // Current values
      living_Person.name("Ann" or "Ben").Loves.commonInterests.get.sortBy(_._1) === List(
        ("Ann", Set("Food", "Walking", "Travelling")),
        ("Ben", Set("Food", "Walking", "Travelling"))
      )

      // Replace
      living_Loves(annBen).commonInterests.replace("Food" -> "Cuisine").update
      living_Person.name("Ann" or "Ben").Loves.commonInterests.get.sortBy(_._1) === List(
      ...
      // Remove
      living_Loves(annBen).commonInterests.remove("Travelling").update
      living_Person.name("Ann" or "Ben").Loves.commonInterests.get.sortBy(_._1) === List(
      ...
      // Add
      living_Loves(annBen).commonInterests.add("Meditating").update
      living_Person.name("Ann" or "Ben").Loves.commonInterests.get.sortBy(_._1) === List(
      ...
      // Apply new values
      living_Loves(annBen).commonInterests("Running", "Cycling").update
      living_Person.name("Ann" or "Ben").Loves.commonInterests.get.sortBy(_._1) === List(
      ...
      // Retract all
      living_Loves(annBen).commonInterests().update
      living_Person.name("Ann" or "Ben").Loves.commonInterests.get === List()
    }
    ...
    "enums" in new Setup {
      ...
      // Current enum values
      living_Person.name("Ann" or "Ben").Loves.commonLicences.get.sortBy(_._1) === List(
        ("Ann", Set("climbing", "flying")),
        ("Ben", Set("climbing", "flying"))
      )

      // Replace
      living_Loves(annBen).commonLicences.replace("flying" -> "diving").update
      living_Person.name("Ann" or "Ben").Loves.commonLicences.get.sortBy(_._1) === List(
      ...
      // Remove
      living_Loves(annBen).commonLicences.remove("climbing").update
      living_Person.name("Ann" or "Ben").Loves.commonLicences.get.sortBy(_._1) === List(
        ("Ann", Set("diving")),
        ("Ben", Set("diving"))
      )
      ...
      // Add
      living_Loves(annBen).commonLicences.add("parachuting").update
      living_Person.name("Ann" or "Ben").Loves.commonLicences.get.sortBy(_._1) === List(
      ...
      // Apply new values
      living_Loves(annBen).commonLicences("climbing", "flying").update
      living_Person.name("Ann" or "Ben").Loves.commonLicences.get.sortBy(_._1) === List(
        ("Ann", Set("climbing", "flying")),
        ("Ben", Set("climbing", "flying"))
      )
      ...
      // Retract all
      living_Loves(annBen).commonLicences().update
      living_Person.name("Ann" or "Ben").Loves.commonLicences.get === List()
    }
    ...
    "refs" in new Setup {
      ...
      // Current value
      living_Person.name("Ann" or "Ben").Loves.InCommon.*(living_Quality.name).get.sortBy(_._1) === List(
      ...
      // replace
      living_Loves(annBen).inCommon.replace(humor -> sporty).update
      living_Person.name("Ann" or "Ben").Loves.InCommon.*(living_Quality.name).get.sortBy(_._1) === List(
      ...
      // remove
      living_Loves(annBen).inCommon.remove(patience).update
      living_Person.name("Ann" or "Ben").Loves.InCommon.*(living_Quality.name).get.sortBy(_._1) === List(
        ("Ann", List("Sporty")),
        ("Ben", List("Sporty"))
      )
      ...
      // add
      living_Loves(annBen).inCommon.add(patience).update
      living_Person.name("Ann" or "Ben").Loves.InCommon.*(living_Quality.name).get.sortBy(_._1) === List(
        ("Ann", List("Waiting ability", "Sporty")),
        ("Ben", List("Waiting ability", "Sporty"))
      )
      ...
      // Apply new values
      living_Loves(annBen).inCommon(sporty, humor).update
      living_Person.name("Ann" or "Ben").Loves.InCommon.*(living_Quality.name).get.sortBy(_._1) === List(
      ...
      living_Loves(annBen).inCommon().update
      living_Person.name("Ann" or "Ben").Loves.InCommon.*(living_Quality.name).get === List()
    }
  }
  ...
  "Map" in new Setup {
    ...
    // Current values
    living_Person.name("Ann" or "Ben").Loves.commonScores.get.sortBy(_._1) === List(
      ("Ann", Map("baseball" -> 9, "golf" -> 7)),
      ("Ben", Map("baseball" -> 9, "golf" -> 7))
    )

    // Replace values by key
    living_Loves(annBen).commonScores.replace("baseball" -> 8, "golf" -> 6).update
    living_Person.name("Ann" or "Ben").Loves.commonScores.get.sortBy(_._1) === List(
    ...
    // Remove by key
    living_Loves(annBen).commonScores.remove("golf").update
    living_Person.name("Ann" or "Ben").Loves.commonScores.get.sortBy(_._1) === List(
      ("Ann", Map("baseball" -> 8)),
      ("Ben", Map("baseball" -> 8))
    )
    ...
    // Add
    living_Loves(annBen).commonScores.add("parachuting" -> 4).update
    living_Person.name("Ann" or "Ben").Loves.commonScores.get.sortBy(_._1) === List(
    ...
    living_Loves(annBen).commonScores("volleball" -> 4, "handball" -> 5).update
    living_Person.name("Ann" or "Ben").Loves.commonScores.get.sortBy(_._1) === List(
    ...
    // Delete all
    living_Loves(annBen).commonScores().update
    living_Person.name("Ann" or "Ben").Loves.commonScores.get === List()
  }
}
