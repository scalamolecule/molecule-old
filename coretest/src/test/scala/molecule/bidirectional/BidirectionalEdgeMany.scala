...
//      living_Person.name("Ben").Knows2.weight(6).Person2.name("Ida").saveD
      ...
      living_Person.name("Ben").Friends.name("Liz").saveD
      living_Person.name("Ben").Knows.weight(7).saveD

//      living_Person.name("Ben").Knows.weight(7).Person.name("Ida").saveD

//      living_Person.name("Ben").Knows.weight(7).Person.name("Ida").save.eids
//
...
//      (living_Person.name("Ben").Knows.weight(7).Person.name("Ida", "Liz").save must throwA[RuntimeException]).message === "Got the exception java.lang.RuntimeException: " +
...
////      (living_Person.name("Ben").Knows.weight(7).Person.*(living_Person.name("Ida")).save must throwA[RuntimeException]).message === "Got the exception java.lang.RuntimeException: " +
...
//      (living_Person.name("Ben").Knows.weight(7).Person.e(ida).save must throwA[RuntimeException]).message === "Got the exception java.lang.RuntimeException: " +
...
//      living_Person.name.Knows.weight.Person.*(living_Person.name) insert List(
//        ("Ben", List("Ida", "Liz")),
//        ("Don", List("Tim", "Tom"))
//      )
//
//      // Bidirectional references have been inserted
//      living_Person.name.Knows.weight.Person.*(living_Person.name).get.sortBy(_._1) === List(
//        ("Ben", List("Ida", "Liz")),
//        ("Don", List("Tim", "Tom")),
//        // Reverse refs:
//        ("Ida", List("Ben")),
...
//      (living_Person.name("Ben").Knows.weight(7).Person.name("Ida", "Liz").update must throwA[RuntimeException]).message === "Got the exception java.lang.RuntimeException: " +
...
//      (living_Person.name("Ben").Knows.weight(7).Person.*(living_Person.name("Ida")).update must throwA[RuntimeException]).message === "Got the exception java.lang.RuntimeException: " +
...
//
//    // Can't update multiple values of cardinality-one attribute `name`
//    (living_Person(ben).Knows.weight(7).Person.name("Ida", "Liz").update must throwA[RuntimeException]).message === "Got the exception java.lang.RuntimeException: " +
//      s"[output.Molecule:noConflictingCardOneValues (1)] Can't update multiple values for cardinality-one attribute:\n" +
//      "  living_Person ... name(Ida, Liz)"
//
//    // Can't update nested data structures
//    (living_Person(ben).Knows.weight(7).Person.*(living_Person.name("Ida")).update must throwA[RuntimeException]).message === "Got the exception java.lang.RuntimeException: " +
//      s"[output.Molecule.noNested] Nested data structures not allowed in update molecules"
//
//    // So, we can't create multiple referenced entities with the `update` command.
