...
//
//      (living_Person.name("Ann").Favorite.weight(5).save must throwA[IllegalArgumentException])
//        .message === "Got the exception java.lang.IllegalArgumentException: " +
//        s"[molecule.api.CheckModel.save_edgeCompleteª]  Missing target namespace after edge namespace `living_Favorite`."
//
...
//
//      (living_Favorite.weight(7).Person.name("Ben").save must throwA[IllegalArgumentException])
//        .message === "Got the exception java.lang.IllegalArgumentException: " +
//        s"[molecule.api.CheckModel.save_edgeCompleteª]  Missing base namespace before edge namespace `living_Person`."
//
//      val targetId = 42L
//      (living_Favorite.weight(7).person(targetId).save must throwA[IllegalArgumentException])
//        .message === "Got the exception java.lang.IllegalArgumentException: " +
//        s"[molecule.api.CheckModel.save_edgeCompleteª]  Missing base namespace before edge namespace `living_Favorite`."
//    }
//
//
...
//        .message === "Got the exception java.lang.IllegalArgumentException: " +
//        s"[molecule.api.CheckModel.save_edgeCompleteª]  Missing target namespace somewhere after edge property `living_Favorite/weight`."
//    }
//
//
...
//      */
//      val List(ann, annFavoriteBen, benFavoriteAnn, ben) = living_Person.name("Ann").Favorite.weight(7).Person.name("Ben").save.eids
//
//      // Bidirectional property edges have been saved
//      living_Person.name.Favorite.weight.Person.name.get.sorted === List(
//        ("Ann", 7, "Ben"),
//        // Reverse edge:
//        ("Ben", 7, "Ann")
//      )
...
//      living_Person.name("Ann").Favorite.weight(7).person(ben).save.eids
//
//      // Ann and Ben know each other with a weight of 7
//      living_Person.name_("Ann").Favorite.weight.Person.name.get === List((7, "Ben"))
//      living_Person.name_("Ben").Favorite.weight.Person.name.get === List((7, "Ann"))
