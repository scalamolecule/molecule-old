...
class UpdateURI extends CoreSpec {
  ...
  "Card-many variables" >> {
    ...
    "remove" in new CoreSetup {
      ...
      Ns.uris.one.toList.sorted === List(uri1, uri2, uri3, uri4, uri5)
      ...
      Ns.uris.one.toList.sorted === List(uri1, uri2, uri3, uri4)

      // Remove multiple values (vararg)
      Ns(eid).uris.remove(uri3, uri4).update
      Ns.uris.one.toList.sorted === List(uri1, uri2)

      // Remove Seq of values
      Ns(eid).uris.remove(Seq(uri2)).update
      Ns.uris.one.toList.sorted === List(uri1)
    ...
    "apply" in new CoreSetup {
      ...
      Ns.uris.one.toList.sorted === List(uri2, uri3)

      // Apply Seq of values
      Ns(eid).uris(Set(uri4)).update
      Ns.uris.one.toList.sorted === List(uri4)
