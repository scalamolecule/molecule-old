...
class UpdateUUID extends CoreSpec {
  ...
  "Card-many variables" >> {
    ...
    "replace" in new CoreSetup {
      ...
      Ns.uuids.one.toList.sortBy(_.toString) === List(uuid1, uuid2, uuid3, uuid4, uuid5, uuid8)
