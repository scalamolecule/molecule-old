...
class UpdateMapURI extends CoreSpec {
  ...
  "Mapped variables" >> {
    ...
    "add" in new CoreSetup {
      ...
      Ns.uriMap.one === Map(str1 -> uri1, str2 -> uri2, str3 -> uri3, str4 -> uri4, str5 -> uri5)
    ...
    "replace" in new CoreSetup {
      ...
      Ns.uriMap.one.toList.sorted === List(str1 -> uri1, str2 -> uri2, str3 -> uri3, str4 -> uri4, str5 -> uri5, str6 -> uri8)

      // Replace value to existing value at another key is ok
      Ns(eid).uriMap.replace(str5 -> uri8).update
      Ns.uriMap.one.toList.sorted === List(str1 -> uri1, str2 -> uri2, str3 -> uri3, str4 -> uri4, str5 -> uri8, str6 -> uri8)

      // Replace multiple values (vararg)
      Ns(eid).uriMap.replace(str3 -> uri6, str4 -> uri7).update
      Ns.uriMap.one.toList.sorted === List(str1 -> uri1, str2 -> uri2, str3 -> uri6, str4 -> uri7, str5 -> uri8, str6 -> uri8)
      ...
      Ns.uriMap.one.toList.sorted === List(str1 -> uri1, str2 -> uri5, str3 -> uri6, str4 -> uri7, str5 -> uri8, str6 -> uri8)
    ...
    "remove" in new CoreSetup {
      ...
      Ns.uriMap.one.toList.sorted === List(str1 -> uri1, str2 -> uri2, str3 -> uri3, str4 -> uri4, str5 -> uri5)
      ...
      Ns.uriMap.one.toList.sorted === List(str1 -> uri1, str2 -> uri2, str3 -> uri3, str4 -> uri4)

      // Remove pairs by multiple keys (vararg)
      Ns(eid).uriMap.remove(str3, str4).update
      Ns.uriMap.one.toList.sorted === List(str1 -> uri1, str2 -> uri2)

      // Remove pairs by Seq of keys
      Ns(eid).uriMap.remove(Seq(str2)).update
      Ns.uriMap.one.toList.sorted === List(str1 -> uri1)
    ...
    "apply" in new CoreSetup {
      ...
      Ns.uriMap.one.toList.sorted === List(str2 -> uri2, str3 -> uri3)

      // Apply Map of values
      Ns(eid).uriMap(Seq(str4 -> uri4)).update
      Ns.uriMap.one.toList.sorted === List(str4 -> uri4)
