...
class UpdateMapFloat extends CoreSpec {
  ...
  "Mapped values" >> {
    ...
    "add" in new CoreSetup {
      ...
      Ns.floatMap.one === Map("str1" -> 1f, "str2" -> 2f, "str3" -> 3f, "str4" -> 4f, "str5" -> 5f)
    ...
    "replace" in new CoreSetup {
      ...
      Ns.floatMap.one.toList.sorted === List("str1" -> 1f, "str2" -> 2f, "str3" -> 3f, "str4" -> 4f, "str5" -> 5f, "str6" -> 8f)

      // Replace value to existing value at another key is ok
      Ns(eid).floatMap.replace("str5" -> 8f).update
      Ns.floatMap.one.toList.sorted === List("str1" -> 1f, "str2" -> 2f, "str3" -> 3f, "str4" -> 4f, "str5" -> 8f, "str6" -> 8f)

      // Replace multiple values (vararg)
      Ns(eid).floatMap.replace("str3" -> 6f, "str4" -> 7f).update
      Ns.floatMap.one.toList.sorted === List("str1" -> 1f, "str2" -> 2f, "str3" -> 6f, "str4" -> 7f, "str5" -> 8f, "str6" -> 8f)
      ...
      Ns.floatMap.one.toList.sorted === List("str1" -> 1f, "str2" -> 5f, "str3" -> 6f, "str4" -> 7f, "str5" -> 8f, "str6" -> 8f)
    ...
    "remove" in new CoreSetup {
      ...
      Ns.floatMap.one.toList.sorted === List("str1" -> 1f, "str2" -> 2f, "str3" -> 3f, "str4" -> 4f, "str5" -> 5f)
      ...
      Ns.floatMap.one.toList.sorted === List("str1" -> 1f, "str2" -> 2f, "str3" -> 3f, "str4" -> 4f)

      // Remove pairs by multiple keys (vararg)
      Ns(eid).floatMap.remove("str3", "str4").update
      Ns.floatMap.one.toList.sorted === List("str1" -> 1f, "str2" -> 2f)

      // Remove pairs by Seq of keys
      Ns(eid).floatMap.remove(Seq("str2")).update
      Ns.floatMap.one.toList.sorted === List("str1" -> 1f)
    ...
    "apply" in new CoreSetup {
      ...
      Ns.floatMap.one.toList.sorted === List("str2" -> 2f, "str3" -> 3f)

      // Apply Map of values
      Ns(eid).floatMap(Seq("str4" -> 4f)).update
      Ns.floatMap.one.toList.sorted === List("str4" -> 4f)
  ...
  "Mapped variables" >> {
    ...
    "add" in new CoreSetup {
      ...
      Ns.floatMap.one === Map(str1 -> float1, str2 -> float3)

      // Add pair at existing key - replaces the value (not the key)
      Ns(eid).floatMap.add(str2 -> float2).update
      Ns.floatMap.one === Map(str1 -> float1, str2 -> float2)

      // Add multiple pairs (vararg)
      Ns(eid).floatMap.add(str3 -> float3, str4 -> float4).update
      Ns.floatMap.one === Map(str1 -> float1, str2 -> float2, str3 -> float3, str4 -> float4)

      // Add Map of pairs. Existing identical pairs (key and value the same) unaffected
      Ns(eid).floatMap.add(Seq(str4 -> float4, str5 -> float5)).update
      Ns.floatMap.one === Map(str1 -> float1, str2 -> float2, str3 -> float3, str4 -> float4, str5 -> float5)
    ...
    "replace" in new CoreSetup {
      ...
      Ns.floatMap.one.toList.sorted === List(str1 -> float1, str2 -> float2, str3 -> float3, str4 -> float4, str5 -> float5, str6 -> float8)

      // Replace value to existing value at another key is ok
      Ns(eid).floatMap.replace(str5 -> float8).update
      Ns.floatMap.one.toList.sorted === List(str1 -> float1, str2 -> float2, str3 -> float3, str4 -> float4, str5 -> float8, str6 -> float8)

      // Replace multiple values (vararg)
      Ns(eid).floatMap.replace(str3 -> float6, str4 -> float7).update
      Ns.floatMap.one.toList.sorted === List(str1 -> float1, str2 -> float2, str3 -> float6, str4 -> float7, str5 -> float8, str6 -> float8)
      ...
      Ns.floatMap.one.toList.sorted === List(str1 -> float1, str2 -> float5, str3 -> float6, str4 -> float7, str5 -> float8, str6 -> float8)
    ...
    "remove" in new CoreSetup {
      ...
      // Remove pair by key
      Ns(eid).floatMap.remove(str6).update
      Ns.floatMap.one.toList.sorted === List(str1 -> float1, str2 -> float2, str3 -> float3, str4 -> float4, str5 -> float5)
      ...
      // Removing duplicate keys removes the distinct key
      Ns(eid).floatMap.remove(str5, str5).update
      Ns.floatMap.one.toList.sorted === List(str1 -> float1, str2 -> float2, str3 -> float3, str4 -> float4)

      // Remove pairs by multiple keys (vararg)
      Ns(eid).floatMap.remove(str3, str4).update
      Ns.floatMap.one.toList.sorted === List(str1 -> float1, str2 -> float2)

      // Remove pairs by Seq of keys
      Ns(eid).floatMap.remove(Seq(str2)).update
      Ns.floatMap.one.toList.sorted === List(str1 -> float1)
    ...
    "apply" in new CoreSetup {
      ...
      Ns.floatMap.one.toList.sorted === List(str2 -> float2, str3 -> float3)

      // Apply Map of values
      Ns(eid).floatMap(Seq(str4 -> float4)).update
      Ns.floatMap.one.toList.sorted === List(str4 -> float4)
