...
class Transactions extends CoreSpec {

  "Applying a value" in new CoreSetup {

//    Ns.str.int insert List(("John", 37), ("Lisa", 28), ("Ben", 28))

//    Ns.str.ints insert List(("John", Set(37, 12)), ("Lisa", Set(28, 7)))
    Ns.str.ints insert List(("John", Set(37, 12)), (null, Set(28, 7)))

//    Ns.str.ints.debug === 24
//    Ns.e.ints.debug === 24
    Ns.ints.debug === 24
