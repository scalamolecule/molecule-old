...
class Input extends CoreSpec {
  ...
  "1 input parameter" >> {
    ...
    "Tacet expressions" in new OneSetup {
      ...
      m(Ns.int.long_.<=(?))(2L).get.sorted === List(1, 2)
      m(Ns.int.long_.>=(?))(2L).get.sorted === List(2, 3)
      m(Ns.int.long_.!=(?))(2L).get.sorted === List(1, 3)
      m(Ns.int.long_.not(?))(2L).get.sorted === List(1, 3)
      ...
      m(Ns.int.bool_.<=(?))(true).get.sorted === List(0, 1)
      m(Ns.int.bool_.>=(?))(true).get === List(1)
      m(Ns.int.bool_.!=(?))(true).get === List(0)
    ...
    "Expressions" in new OneSetup {
      ...
      m(Ns.int_.bool.<=(?))(true).get.sorted === List(false, true)
      m(Ns.int_.bool.>=(?))(true).get === List(true)
      m(Ns.int_.bool.!=(?))(true).get === List(false)
    ...
    "Cardinality-many expressions" in new ManySetup {
      ...
      m(Ns.long.ints_(?))(Set(1)).get.sorted === List(1L)
      ...
      m(Ns.int.bools_(?))(Set(true)).get.sorted === List(1, 2)
      m(Ns.int.bools_.<(?))(Set(true)).get.sorted === List(0, 2)
      m(Ns.int.bools_.>(?))(Set(true)).get.sorted === List()
      m(Ns.int.bools_.<=(?))(Set(true)).get.sorted === List(0, 1, 2)
      m(Ns.int.bools_.>=(?))(Set(true)).get.sorted === List(1, 2)
      m(Ns.int.bools_.!=(?))(Set(true)).get.sorted === List(0, 2)
      m(Ns.int.bools_.not(?))(Set(true)).get.sorted === List(0, 2)
    ...
    "OR-logic" in new OneSetup {
      m(Ns.int.str_(?))("a" or "b").get.sorted === List(1, 2)
      m(Ns.int.str_(?))("a", "b").get.sorted === List(1, 2)
      m(Ns.int.str_(?))(Seq("a", "b")).get.sorted === List(1, 2)
      ...
      m(Ns.int.str_(?))(ab).get.sorted === List(1, 2)
