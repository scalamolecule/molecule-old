...
//  }
  ...
  "Card many - AND" in new CoreSetup {
...
//    "Card-one attribute" in new ManySetup {
...
//      Ns.str.strs("b").debug
    ...
    // [[1 #{"a" "b" "c"}] [2 #{"d" "e" "c"}] [3 #{"f" "e" "g"}]]

//      [?a :ns/strs "b"]
//      [?a :ns/strs "c"]
//      Ns.int.strs("b" or "c").debug
//      Ns.int.strs("b" and "c").debug

    Ns.int.strs.get === 7
    // List((1,Set(a, b, c)), (2,Set(d, e, c)), (3,Set(f, e, g)))
    /*
    List(
      (1, Set(a, b, c)),
      (2, Set(d, e, c)),
    ...
    * */
      ...
      Ns.str.strs_("b" and "c").get === List("str2")

      Ns.str.strs("b" and "c").get === List(("str2", Set("b", "c")))
//    }

//    "Card-many attribute" in new ManySetup {
//
//    }
//
//
//    "Attribute of card-one ref" in new ManySetup {
//
...
//    }
//
//    "Attribute of card-many ref" in new ManySetup {
//
//    }
  }
}