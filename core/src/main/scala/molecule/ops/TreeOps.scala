...
//    case (1, 0)  => tq"molecule.input.InputMolecule_1.InputMolecule_1_00"
    case (1, 1)  => tq"molecule.input.InputMolecule_1.InputMolecule_1_01"
    case (1, 2)  => tq"molecule.input.InputMolecule_1.InputMolecule_1_02"
    case (1, 3)  => tq"molecule.input.InputMolecule_1.InputMolecule_1_03"
    case (1, 4)  => tq"molecule.input.InputMolecule_1.InputMolecule_1_04"
    case (1, 5)  => tq"molecule.input.InputMolecule_1.InputMolecule_1_05"
    case (1, 6)  => tq"molecule.input.InputMolecule_1.InputMolecule_1_06"
    case (1, 7)  => tq"molecule.input.InputMolecule_1.InputMolecule_1_07"
    case (1, 8)  => tq"molecule.input.InputMolecule_1.InputMolecule_1_08"
    case (1, 9)  => tq"molecule.input.InputMolecule_1.InputMolecule_1_09"
    case (1, 10) => tq"molecule.input.InputMolecule_1.InputMolecule_1_10"
    case (1, 11) => tq"molecule.input.InputMolecule_1.InputMolecule_1_11"
    case (1, 12) => tq"molecule.input.InputMolecule_1.InputMolecule_1_12"
    case (1, 13) => tq"molecule.input.InputMolecule_1.InputMolecule_1_13"
    case (1, 14) => tq"molecule.input.InputMolecule_1.InputMolecule_1_14"
    case (1, 15) => tq"molecule.input.InputMolecule_1.InputMolecule_1_15"
    case (1, 16) => tq"molecule.input.InputMolecule_1.InputMolecule_1_16"
    case (1, 17) => tq"molecule.input.InputMolecule_1.InputMolecule_1_17"
    case (1, 18) => tq"molecule.input.InputMolecule_1.InputMolecule_1_18"
    case (1, 19) => tq"molecule.input.InputMolecule_1.InputMolecule_1_19"
    case (1, 20) => tq"molecule.input.InputMolecule_1.InputMolecule_1_20"
    case (1, 21) => tq"molecule.input.InputMolecule_1.InputMolecule_1_21"
    case (1, 22) => tq"molecule.input.InputMolecule_1.InputMolecule_1_22"

//    case (2, 0)  => tq"molecule.input.InputMolecule_2.InputMolecule_2_00"
    case (2, 1)  => tq"molecule.input.InputMolecule_2.InputMolecule_2_01"
    case (2, 2)  => tq"molecule.input.InputMolecule_2.InputMolecule_2_02"
    case (2, 3)  => tq"molecule.input.InputMolecule_2.InputMolecule_2_03"
    case (2, 4)  => tq"molecule.input.InputMolecule_2.InputMolecule_2_04"
    case (2, 5)  => tq"molecule.input.InputMolecule_2.InputMolecule_2_05"
    case (2, 6)  => tq"molecule.input.InputMolecule_2.InputMolecule_2_06"
    case (2, 7)  => tq"molecule.input.InputMolecule_2.InputMolecule_2_07"
    case (2, 8)  => tq"molecule.input.InputMolecule_2.InputMolecule_2_08"
    case (2, 9)  => tq"molecule.input.InputMolecule_2.InputMolecule_2_09"
    case (2, 10) => tq"molecule.input.InputMolecule_2.InputMolecule_2_10"
    case (2, 11) => tq"molecule.input.InputMolecule_2.InputMolecule_2_11"
    case (2, 12) => tq"molecule.input.InputMolecule_2.InputMolecule_2_12"
    case (2, 13) => tq"molecule.input.InputMolecule_2.InputMolecule_2_13"
    case (2, 14) => tq"molecule.input.InputMolecule_2.InputMolecule_2_14"
    case (2, 15) => tq"molecule.input.InputMolecule_2.InputMolecule_2_15"
    case (2, 16) => tq"molecule.input.InputMolecule_2.InputMolecule_2_16"
    case (2, 17) => tq"molecule.input.InputMolecule_2.InputMolecule_2_17"
    case (2, 18) => tq"molecule.input.InputMolecule_2.InputMolecule_2_18"
    case (2, 19) => tq"molecule.input.InputMolecule_2.InputMolecule_2_19"
    case (2, 20) => tq"molecule.input.InputMolecule_2.InputMolecule_2_20"
    case (2, 21) => tq"molecule.input.InputMolecule_2.InputMolecule_2_21"
    case (2, 22) => tq"molecule.input.InputMolecule_2.InputMolecule_2_22"

//    case (3, 0)  => tq"molecule.input.InputMolecule_3.InputMolecule_3_00"
    case (3, 1)  => tq"molecule.input.InputMolecule_3.InputMolecule_3_01"
    case (3, 2)  => tq"molecule.input.InputMolecule_3.InputMolecule_3_02"
    case (3, 3)  => tq"molecule.input.InputMolecule_3.InputMolecule_3_03"
    case (3, 4)  => tq"molecule.input.InputMolecule_3.InputMolecule_3_04"
    case (3, 5)  => tq"molecule.input.InputMolecule_3.InputMolecule_3_05"
    case (3, 6)  => tq"molecule.input.InputMolecule_3.InputMolecule_3_06"
    case (3, 7)  => tq"molecule.input.InputMolecule_3.InputMolecule_3_07"
    case (3, 8)  => tq"molecule.input.InputMolecule_3.InputMolecule_3_08"
    case (3, 9)  => tq"molecule.input.InputMolecule_3.InputMolecule_3_09"
    case (3, 10) => tq"molecule.input.InputMolecule_3.InputMolecule_3_10"
    case (3, 11) => tq"molecule.input.InputMolecule_3.InputMolecule_3_11"
    case (3, 12) => tq"molecule.input.InputMolecule_3.InputMolecule_3_12"
    case (3, 13) => tq"molecule.input.InputMolecule_3.InputMolecule_3_13"
    case (3, 14) => tq"molecule.input.InputMolecule_3.InputMolecule_3_14"
    case (3, 15) => tq"molecule.input.InputMolecule_3.InputMolecule_3_15"
    case (3, 16) => tq"molecule.input.InputMolecule_3.InputMolecule_3_16"
    case (3, 17) => tq"molecule.input.InputMolecule_3.InputMolecule_3_17"
    case (3, 18) => tq"molecule.input.InputMolecule_3.InputMolecule_3_18"
    case (3, 19) => tq"molecule.input.InputMolecule_3.InputMolecule_3_19"
    case (3, 20) => tq"molecule.input.InputMolecule_3.InputMolecule_3_20"
    case (3, 21) => tq"molecule.input.InputMolecule_3.InputMolecule_3_21"
    case (3, 22) => tq"molecule.input.InputMolecule_3.InputMolecule_3_22"
  ...
  def molecule_o(outArity: Int) = outArity match {
    case 1  => tq"molecule.action.Molecule.Molecule01"
    case 2  => tq"molecule.action.Molecule.Molecule02"
    case 3  => tq"molecule.action.Molecule.Molecule03"
    case 4  => tq"molecule.action.Molecule.Molecule04"
    case 5  => tq"molecule.action.Molecule.Molecule05"
    case 6  => tq"molecule.action.Molecule.Molecule06"
    case 7  => tq"molecule.action.Molecule.Molecule07"
    case 8  => tq"molecule.action.Molecule.Molecule08"
    case 9  => tq"molecule.action.Molecule.Molecule09"
    case 10 => tq"molecule.action.Molecule.Molecule10"
    case 11 => tq"molecule.action.Molecule.Molecule11"
    case 12 => tq"molecule.action.Molecule.Molecule12"
    case 13 => tq"molecule.action.Molecule.Molecule13"
    case 14 => tq"molecule.action.Molecule.Molecule14"
    case 15 => tq"molecule.action.Molecule.Molecule15"
    case 16 => tq"molecule.action.Molecule.Molecule16"
    case 17 => tq"molecule.action.Molecule.Molecule17"
    case 18 => tq"molecule.action.Molecule.Molecule18"
    case 19 => tq"molecule.action.Molecule.Molecule19"
    case 20 => tq"molecule.action.Molecule.Molecule20"
    case 21 => tq"molecule.action.Molecule.Molecule21"
    case 22 => tq"molecule.action.Molecule.Molecule22"
  ...
  class att(val sym: Symbol) {
    ...
    lazy val tpe = sym match {
      ...
      case t: TermSymbol if t.isPublic && t.typeSignature.typeSymbol.asType.toType <:< weakTypeOf[OptionalExpr[_, _]]    =>
        t.typeSignature.baseType(weakTypeOf[OptionalExpr[_, _]].typeSymbol).typeArgs.last
