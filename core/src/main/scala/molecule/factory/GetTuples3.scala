...
//  }
////
////  def getNestedTuples2(tpes: Seq[Type]) =
////    q"""
...
////                               indexMap)
////
//////      {resolveNested(q"query", tpes, q"prevTpl", q"prevRow", q"row", 0, 1, q"maxDepth", 1)}
////
...
////"""
////
////  def getNestedTuples3(tpes: Seq[Type]) =
////    q"""
...
////
////            case tpe =>
////              (shift, vs :+ ${cast2(q"query", q"row.asJava", tq"tpe", q"indexMap(entityIndex + shift + typeIndex)")})
////          }
////        }._2
////      } // getValues
////"""
////
////  def getNestedTuples4(tpes: Seq[Type]) =
////    q"""
