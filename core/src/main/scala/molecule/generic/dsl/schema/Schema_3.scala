...
trait Schema_3[A, B, C] extends Schema with OutSchema_3[Schema_3, A, B, C] {
  type Next[Attr[_, _], Type] = Attr[Schema_4[A, B, C, Type], P5[_,_,_,_,_]] with Schema_4[A, B, C, Type]
  type Stay[Attr[_, _], Type] = Attr[Schema_3[A, B, C], P4[_,_,_,_]] with Schema_3[A, B, C]
