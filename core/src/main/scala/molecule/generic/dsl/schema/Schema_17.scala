...
trait Schema_17[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q] extends Schema with OutSchema_17[Schema_17, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q] {
  type Next[Attr[_, _], Type] = Attr[Schema_18[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, Type], P19[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_]] with Schema_18[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, Type]
  type Stay[Attr[_, _], Type] = Attr[Schema_17[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q], P18[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_]] with Schema_17[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q]
