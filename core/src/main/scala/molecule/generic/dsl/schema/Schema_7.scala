...
trait Schema_7[A, B, C, D, E, F, G] extends Schema with OutSchema_7[Schema_7, A, B, C, D, E, F, G] {
  type Next[Attr[_, _], Type] = Attr[Schema_8[A, B, C, D, E, F, G, Type], P9[_,_,_,_,_,_,_,_,_]] with Schema_8[A, B, C, D, E, F, G, Type]
  type Stay[Attr[_, _], Type] = Attr[Schema_7[A, B, C, D, E, F, G], P8[_,_,_,_,_,_,_,_]] with Schema_7[A, B, C, D, E, F, G]
