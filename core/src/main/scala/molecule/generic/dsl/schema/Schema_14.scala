...
trait Schema_14[A, B, C, D, E, F, G, H, I, J, K, L, M, N] extends Schema with OutSchema_14[Schema_14, A, B, C, D, E, F, G, H, I, J, K, L, M, N] {
  type Next[Attr[_, _], Type] = Attr[Schema_15[A, B, C, D, E, F, G, H, I, J, K, L, M, N, Type], P16[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_]] with Schema_15[A, B, C, D, E, F, G, H, I, J, K, L, M, N, Type]
  type Stay[Attr[_, _], Type] = Attr[Schema_14[A, B, C, D, E, F, G, H, I, J, K, L, M, N], P15[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_]] with Schema_14[A, B, C, D, E, F, G, H, I, J, K, L, M, N]
