...
trait Schema_10[A, B, C, D, E, F, G, H, I, J] extends Schema with OutSchema_10[Schema_10, A, B, C, D, E, F, G, H, I, J] {
  type Next[Attr[_, _], Type] = Attr[Schema_11[A, B, C, D, E, F, G, H, I, J, Type], P12[_,_,_,_,_,_,_,_,_,_,_,_]] with Schema_11[A, B, C, D, E, F, G, H, I, J, Type]
  type Stay[Attr[_, _], Type] = Attr[Schema_10[A, B, C, D, E, F, G, H, I, J], P11[_,_,_,_,_,_,_,_,_,_,_]] with Schema_10[A, B, C, D, E, F, G, H, I, J]
