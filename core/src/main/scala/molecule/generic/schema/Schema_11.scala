...
trait Schema_11[A, B, C, D, E, F, G, H, I, J, K] extends Schema with OutSchema_11[Schema_11, A, B, C, D, E, F, G, H, I, J, K] {
  type Next[Attr[_, _], Type] = Attr[Schema_12[A, B, C, D, E, F, G, H, I, J, K, Type], P13[_,_,_,_,_,_,_,_,_,_,_,_,_]] with Schema_12[A, B, C, D, E, F, G, H, I, J, K, Type]
  type Stay[Attr[_, _], Type] = Attr[Schema_11[A, B, C, D, E, F, G, H, I, J, K], P12[_,_,_,_,_,_,_,_,_,_,_,_]] with Schema_11[A, B, C, D, E, F, G, H, I, J, K]
