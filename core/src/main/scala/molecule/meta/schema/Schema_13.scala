...
trait Schema_13[A, B, C, D, E, F, G, H, I, J, K, L, M] extends Schema with OutSchema_13[Schema_13, A, B, C, D, E, F, G, H, I, J, K, L, M] {
  type Next[Attr[_, _], Type] = Attr[Schema_14[A, B, C, D, E, F, G, H, I, J, K, L, M, Type], P15[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_]] with Schema_14[A, B, C, D, E, F, G, H, I, J, K, L, M, Type]
  type Stay[Attr[_, _], Type] = Attr[Schema_13[A, B, C, D, E, F, G, H, I, J, K, L, M], P14[_,_,_,_,_,_,_,_,_,_,_,_,_,_]] with Schema_13[A, B, C, D, E, F, G, H, I, J, K, L, M]
