...
trait GetAsyncRaw { self: MoleculeBase with GetRaw =>
  ...
  /** Get `Future` with `java.util.Collection` of all untyped rows matching molecule.
    ...
    * [[molecule.api.get.GetRaw.getRaw(implicit* getRaw]] method.
    *
    * @group getAsync
  ...
  /** Get `Future` with `java.util.Collection` of n untyped rows matching molecule.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRaw(n:Int)* getRaw]] method.
    *
    * @group getAsync
  ...
  /** Get `Future` with `java.util.Collection` of all untyped rows matching molecule as of transaction time `t`.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawAsOf(t:Long)* getRawAsOf]] method.
    *
  ...
  /** Get `Future` with `java.util.Collection` of n untyped rows matching molecule as of transaction time `t`.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawAsOf(t:Long,n:Int)* getRawAsOf]] method.
    *
    * @group getAsyncRawAsOf
    * @param t    Transaction time t
  ...
  /** Get `Future` with `java.util.Collection` of all untyped rows matching molecule as of tx.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawAsOf(tx:molecule\.facade\.TxReport)* getRawAsOf]] method.
    *
    * @group getAsyncRawAsOf
    ...
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    */
  def getAsyncRawAsOf(tx: molecule.facade.TxReport)(implicit conn: Conn): Future[jCollection[jList[AnyRef]]] =
  ...
  /** Get `Future` with `java.util.Collection` of n untyped rows matching molecule as of tx.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawAsOf(tx:molecule\.facade\.TxReport,n:Int)* getRawAsOf]] method.
    *
    * @group getAsyncRawAsOf
    * @param tx   [[molecule.facade.TxReport TxReport]] (returned from all molecule transaction operations)
    * @param n    Int Number of rows returned
    ...
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    */
  def getAsyncRawAsOf(tx: molecule.facade.TxReport, n: Int)(implicit conn: Conn): Future[jCollection[jList[AnyRef]]] =
  ...
  /** Get `Future` with `java.util.Collection` of all untyped rows matching molecule as of date.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawAsOf(date:java\.util\.Date)* getRawAsOf]] method.
    *
    * @group getAsyncRawAsOf
  ...
  /** Get `Future` with `java.util.Collection` of n untyped rows matching molecule as of date.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawAsOf(date:java\.util\.Date,n:Int)* getRawAsOf]] method.
    *
    * @group getAsyncRawAsOf
    * @param date java.util.Date
    * @param n    Int Number of rows returned
  ...
  /** Get `Future` with `java.util.Collection` of all untyped rows matching molecule since transaction time `t`.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawSince(t:Long)* getRawSince]] method.
    *
  ...
  /** Get `Future` with `java.util.Collection` of n untyped rows matching molecule since transaction time `t`.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawSince(t:Long,n:Int)* getRawSince]] method.
    *
    * @group getAsyncRawSince
    * @param t    Transaction time t
    * @param n    Int Number of rows returned
  ...
  /** Get `Future` with `java.util.Collection` of all untyped rows matching molecule since tx.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawSince(tx:molecule\.facade\.TxReport)* getRawSince]] method.
    *
    * @group getAsyncRawSince
    * @param tx   [[molecule.facade.TxReport TxReport]] (returned from all molecule transaction operations)
    * @param conn Implicit [[molecule.facade.Conn Conn]] value in scope
    ...
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    */
  def getAsyncRawSince(tx: molecule.facade.TxReport)(implicit conn: Conn): Future[jCollection[jList[AnyRef]]] =
  ...
  /** Get `Future` with `java.util.Collection` of n untyped rows matching molecule since tx.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawSince(tx:molecule\.facade\.TxReport,n:Int)* getRawSince]] method.
    *
    * @group getAsyncRawSince
    * @param tx   [[molecule.facade.TxReport TxReport]] (returned from all molecule transaction operations)
    * @param n    Int Number of rows returned
    ...
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    */
  def getAsyncRawSince(tx: molecule.facade.TxReport, n: Int)(implicit conn: Conn): Future[jCollection[jList[AnyRef]]] =
  ...
  /** Get `Future` with `java.util.Collection` of all untyped rows matching molecule since date.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawSince(date:java\.util\.Date)* getRawSince]] method.
    *
    * @group getAsyncRawSince
    * @param date java.util.Date
    * @param conn Implicit [[molecule.facade.Conn Conn]] value in scope
  ...
  /** Get `Future` with `java.util.Collection` of n untyped rows matching molecule since date.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawSince(date:java\.util\.Date,n:Int)* getRawSince]] method.
    *
    * @group getAsyncRawSince
    * @param date java.util.Date
    * @param n    Int Number of rows returned
  ...
  /** Get `Future` with `java.util.Collection` of all untyped rows matching molecule with applied molecule transaction data.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawWith(txMolecules* getRawWith]] method.
    * <br><br>
  ...
  /** Get `Future` with `java.util.Collection` of n untyped rows matching molecule with applied molecule transaction data.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawWith(n:Int,txMolecules* getRawWith]] method.
    * <br><br>
    * Multiple transactions can be applied to test more complex what-if scenarios!
    *
    * @group getAsyncRawWith
  ...
  /** Get `Future` with `java.util.Collection` of all untyped rows matching molecule with applied raw transaction data.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawWith(txData:java\.util\.List[_])* getRawWith]] method.
    *
    * @group getAsyncRawWith
  ...
  /** Get `Future` with `java.util.Collection` of n untyped rows matching molecule with applied raw transaction data.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetRaw.getRawWith(txData:java\.util\.List[_],n:Int)* getRawWith]] method.
    *
    * @group getAsyncRawWith
    * @param txData Raw transaction data as java.util.List[Object]
    * @param n      Int Number of rows returned
