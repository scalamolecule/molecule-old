...
trait GetAsyncArray[Tpl] { self: Molecule[Tpl] with GetArray[Tpl] =>
  ...
  /** Get `Future` with `Array` of all rows as tuples matching molecule.
    ...
    * [[molecule.api.get.GetArray.getArray(implicit* getArray]] method.
    *
    * @group getAsync
  ...
  /** Get `Future` with `Array` of n rows as tuples matching molecule.
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArray(n:Int)* getArray]] method.
    *
    * @group getAsync
  ...
  /** Get `Future` with `Array` of all rows as tuples matching molecule as of transaction time `t`.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArrayAsOf(t:Long)* getArrayAsOf]] method.
    * <br><br>
  ...
  /** Get `Future` with `Array` of n rows as tuples matching molecule as of transaction time `t`.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArrayAsOf(t:Long,n:Int)* getArrayAsOf]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
  ...
  /** Get `Future` with `Array` of all rows as tuples matching molecule as of tx.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArrayAsOf(tx:molecule\.facade\.TxReport)* getArrayAsOf]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
    ...
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    **/
  def getAsyncArrayAsOf(tx: molecule.facade.TxReport)(implicit conn: Conn, tplType: ClassTag[Tpl]): Future[Array[Tpl]] =
  ...
  /** Get `Future` with `Array` of n rows as tuples matching molecule as of tx.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArrayAsOf(tx:molecule\.facade\.TxReport,n:Int)* getArrayAsOf]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
    ...
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    **/
  def getAsyncArrayAsOf(tx: molecule.facade.TxReport, n: Int)(implicit conn: Conn, tplType: ClassTag[Tpl]): Future[Array[Tpl]] =
  ...
  /** Get `Future` with `Array` of all rows as tuples matching molecule as of date.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArrayAsOf(date:java\.util\.Date)* getArrayAsOf]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
  ...
  /** Get `Future` with `Array` of n rows as tuples matching molecule as of date.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArrayAsOf(date:java\.util\.Date,n:Int)* getArrayAsOf]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
  ...
  /** Get `Future` with `Array` of all rows as tuples matching molecule since transaction time `t`.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArraySince(t:Long)* getArraySince]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
  ...
  /** Get `Future` with `Array` of n rows as tuples matching molecule since transaction time `t`.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArraySince(t:Long,n:Int)* getArraySince]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
  ...
  /** Get `Future` with `Array` of all rows as tuples matching molecule since tx.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArraySince(tx:molecule\.facade\.TxReport)* getArraySince]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
    ...
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    */
  def getAsyncArraySince(tx: molecule.facade.TxReport)(implicit conn: Conn, tplType: ClassTag[Tpl]): Future[Array[Tpl]] =
  ...
  /** Get `Future` with `Array` of n rows as tuples matching molecule since tx.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArraySince(tx:molecule\.facade\.TxReport,n:Int)* getArraySince]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
    ...
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    **/
  def getAsyncArraySince(tx: molecule.facade.TxReport, n: Int)(implicit conn: Conn, tplType: ClassTag[Tpl]): Future[Array[Tpl]] =
  ...
  /** Get `Future` with `Array` of all rows as tuples matching molecule since date.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArraySince(date:java\.util\.Date)* getArraySince]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
  ...
  /** Get `Future` with `Array` of n rows as tuples matching molecule since date.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArraySince(date:java\.util\.Date,n:Int)* getArraySince]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
  ...
  /** Get `Future` with `Array` of all rows as tuples matching molecule with applied molecule transaction data.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArrayWith(txMolecules* getArrayWith]] method.
    * <br><br>
  ...
  /** Get `Future` with `Array` of n rows as tuples matching molecule with applied molecule transaction data.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArrayWith(n:Int,txMolecules* getArrayWith]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
  ...
  /** Get `Future` with `Array` of all rows as tuples matching molecule with applied raw transaction data.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArrayWith(txData:java\.util\.List[_])* getArrayWith]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
  ...
  /** Get `Future` with `Array` of n rows as tuples matching molecule with applied raw transaction data.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.api.get.GetArray.getArrayWith(txData:java\.util\.List[_],n:Int)* getArrayWith]] method.
    * <br><br>
    * Getting a pre-allocated Array populated with typed data is the fastest way to query
    * Datomic with Molecule. Looping the Array in a while loop with a mutable index pointer will
    * also be the fastest way to traverse the data set.
