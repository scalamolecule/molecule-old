...
trait GetArray[Tpl] { self: Molecule[Tpl] =>
  ...
  /** Get `Array` of all rows as tuples matching molecule.
    ...
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArray(implicit* getAsyncArray]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of types matching the attributes of the molecule
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArray(n:Int)* getAsyncArray]] method.
    */
  ...
  /** Get `Array` of all rows as tuples matching molecule as of transaction time `t`.
    ...
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArrayAsOf(t:Long)* getAsyncArrayAsOf]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule as of transaction time `t`.
    ...
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArrayAsOf(t:Long,n:Int)* getAsyncArrayAsOf]] method.
    */
  ...
  /** Get `Array` of all rows as tuples matching molecule as of tx.
    ...
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArrayAsOf(tx:molecule\.facade\.TxReport)* getAsyncArrayAsOf]] method.
    **/
  def getArrayAsOf(tx: molecule.facade.TxReport)(implicit conn: Conn, tplType: ClassTag[Tpl]): Array[Tpl] =
  ...
  /** Get `Array` of n rows as tuples matching molecule as of tx.
    ...
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArrayAsOf(tx:molecule\.facade\.TxReport,n:Int)* getAsyncArrayAsOf]] method.
    **/
  def getArrayAsOf(tx: molecule.facade.TxReport, n: Int)(implicit conn: Conn, tplType: ClassTag[Tpl]): Array[Tpl] =
  ...
  /** Get `Array` of all rows as tuples matching molecule as of date.
    ...
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArrayAsOf(date:java\.util\.Date)* getAsyncArrayAsOf]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule as of date.
    ...
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArrayAsOf(date:java\.util\.Date,n:Int)* getAsyncArrayAsOf]] method.
    */
  ...
  /** Get `Array` of all rows as tuples matching molecule since transaction time `t`.
    ...
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArraySince(t:Long)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule since transaction time `t`.
    ...
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArraySince(t:Long,n:Int)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of all rows as tuples matching molecule since tx.
    ...
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArraySince(tx:molecule\.facade\.TxReport)* getAsyncArraySince]] method.
    */
  def getArraySince(tx: molecule.facade.TxReport)(implicit conn: Conn, tplType: ClassTag[Tpl]): Array[Tpl] =
  ...
  /** Get `Array` of n rows as tuples matching molecule since tx.
    ...
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArraySince(tx:molecule\.facade\.TxReport,n:Int)* getAsyncArraySince]] method.
    **/
  def getArraySince(tx: molecule.facade.TxReport, n: Int)(implicit conn: Conn, tplType: ClassTag[Tpl]): Array[Tpl] =
  ...
  /** Get `Array` of all rows as tuples matching molecule since date.
    ...
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArraySince(date:java\.util\.Date)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule since date.
    ...
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArraySince(date:java\.util\.Date,n:Int)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of all rows as tuples matching molecule with applied molecule transaction data.
    ...
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArrayWith(txMolecules* getAsyncArrayWith]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule with applied molecule transaction data.
    ...
    * @see [[http://www.scalamolecule.org/manual/time/with/ Manual]] on `with`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncArray.getAsyncArrayWith(n:Int,txMolecules* getAsyncArrayWith]] method.
    */
