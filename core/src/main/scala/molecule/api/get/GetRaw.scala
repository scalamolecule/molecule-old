...
trait GetRaw { self: MoleculeBase =>
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule.
    ...
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRaw(implicit* getAsyncRaw]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule.
    ...
    * @param conn Implicit [[molecule.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRaw(n:Int)* getAsyncRaw]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule as of transaction time `t`.
    ...
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawAsOf(t:Long)* getAsyncRawAsOf]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule as of transaction time `t`.
    ...
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawAsOf(t:Long,n:Int)* getAsyncRawAsOf]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule as of tx.
    ...
    * getAsync a [[molecule.facade.TxReport TxReport]] from transaction operations like `get`, `update`, `retract` etc.
    * {{{
    *   // Insert (tx report 1)
    ...
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawAsOf(tx:molecule\.facade\.TxReport)* getAsyncRawAsOf]] method.
    */
  def getRawAsOf(tx: molecule.facade.TxReport)(implicit conn: Conn): jCollection[jList[AnyRef]] =
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule as of tx.
    ...
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawAsOf(tx:molecule\.facade\.TxReport,n:Int)* getAsyncRawAsOf]] method.
    */
  def getRawAsOf(tx: molecule.facade.TxReport, n: Int)(implicit conn: Conn): jCollection[jList[AnyRef]] =
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule as of date.
    ...
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawAsOf(date:java\.util\.Date)* getAsyncRawAsOf]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule as of date.
    ...
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawAsOf(date:java\.util\.Date,n:Int)* getAsyncRawAsOf]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule since transaction time `t`.
    ...
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawSince(t:Long)* getAsyncRawSince]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule since transaction time `t`.
    ...
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawSince(t:Long,n:Int)* getAsyncRawSince]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule since tx.
    ...
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawSince(tx:molecule\.facade\.TxReport)* getAsyncRawSince]] method.
    */
  def getRawSince(tx: molecule.facade.TxReport)(implicit conn: Conn): jCollection[jList[AnyRef]] =
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule since tx.
    ...
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawSince(tx:molecule\.facade\.TxReport,n:Int)* getAsyncRawSince]] method.
    */
  def getRawSince(tx: molecule.facade.TxReport, n: Int)(implicit conn: Conn): jCollection[jList[AnyRef]] =
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule since date.
    ...
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawSince(date:java\.util\.Date)* getAsyncRawSince]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule since date.
    ...
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawSince(date:java\.util\.Date,n:Int)* getAsyncRawSince]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule with applied molecule transaction data.
    ...
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawWith(txMolecules* getAsyncRawWith]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule with applied molecule transaction data.
    ...
    * @see [[http://www.scalamolecule.org/manual/time/with/ Manual]] on `with`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawWith(n:Int,txMolecules* getAsyncRawWith]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule with applied raw transaction data.
    ...
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see [[http://www.scalamolecule.org/manual/time/with/ Manual]] on `with`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawWith(txData:java\.util\.List[_])* getAsyncRawWith]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule with applied raw transaction data.
    ...
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see [[http://www.scalamolecule.org/manual/time/with/ Manual]] on `with`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncRaw.getAsyncRawWith(txData:java\.util\.List[_],n:Int)* getAsyncRawWith]] method.
    */
