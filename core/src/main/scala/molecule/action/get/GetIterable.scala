...
trait GetIterable[Tpl] { self: Molecule[Tpl] =>
  ...
  /** Get Iterable of all rows as tuples matching the molecule.
    ...
    */
  def getIterable(implicit conn: Conn, ev: ClassTag[Tpl]): Iterable[Tpl] = new Iterable[Tpl] {
  ...
  /** Get Iterable of all rows as tuples matching molecule as of transaction time `t`.
    ...
    */
  def getIterableAsOf(t: Long)(implicit conn: Conn, ev: ClassTag[Tpl]): Iterable[Tpl] =
    getIterable(conn.usingTempDb(AsOf(TxLong(t))), ev)
  ...
  /** Get Iterable of all rows as tuples matching molecule as of tx.
    ...
    * @return Iterable[Tpl] where Tpl is tuple of data matching molecule
    */
  def getIterableAsOf(tx: TxReport)(implicit conn: Conn, ev: ClassTag[Tpl]): Iterable[Tpl] =
    getIterable(conn.usingTempDb(AsOf(TxLong(tx.t))), ev)
  ...
  /** Get Iterable of all rows as tuples matching molecule as of date.
    ...
    * @return Iterable[Tpl] where Tpl is tuple of data matching molecule
    */
  def getIterableAsOf(date: Date)(implicit conn: Conn, ev: ClassTag[Tpl]): Iterable[Tpl] =
    getIterable(conn.usingTempDb(AsOf(TxDate(date))), ev)
  ...
  /** Get Iterable of all rows as tuples matching molecule since transaction time `t`.
    ...
    * @return Iterable[Tpl] where Tpl is tuple of data matching molecule
    */
  def getIterableSince(t: Long)(implicit conn: Conn, ev: ClassTag[Tpl]): Iterable[Tpl] =
    getIterable(conn.usingTempDb(Since(TxLong(t))), ev)
  ...
  /** Get Iterable of all rows as tuples matching molecule since tx.
    ...
    * @return Iterable[Tpl] where Tpl is tuple of data matching molecule
    */
  def getIterableSince(tx: TxReport)(implicit conn: Conn, ev: ClassTag[Tpl]): Iterable[Tpl] =
    getIterable(conn.usingTempDb(Since(TxLong(tx.t))), ev)
  ...
  /** Get Iterable of all rows as tuples matching molecule since date.
    ...
    * @return Iterable[Tpl] where Tpl is tuple of data matching molecule
    */
  def getIterableSince(date: Date)(implicit conn: Conn, ev: ClassTag[Tpl]): Iterable[Tpl] =
    getIterable(conn.usingTempDb(Since(TxDate(date))), ev)
  ...
  /** Get Iterable of all rows as tuples matching molecule with applied molecule transaction data.
    ...
    */
  def getIterableWith(txMolecules: Seq[Seq[Statement]]*)(implicit conn: Conn, ev: ClassTag[Tpl]): Iterable[Tpl] =
    getIterable(conn.usingTempDb(With(txMolecules.flatten.flatten.map(_.toJava).asJava)), ev)
  ...
  /** Get Iterable of all rows as tuples matching molecule with applied raw transaction data.
    ...
    * @return Iterable of molecule data
    */
  def getIterableWith(txData: jList[_])(implicit conn: Conn, ev: ClassTag[Tpl]): Iterable[Tpl] =
    getIterable(conn.usingTempDb(With(txData.asInstanceOf[jList[jList[_]]])), ev)
