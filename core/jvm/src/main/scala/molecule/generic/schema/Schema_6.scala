...
trait Schema_6[A, B, C, D, E, F] extends Schema with OutSchema_6[Schema_6, A, B, C, D, E, F] {
  type Next[Attr[_, _], Type] = Attr[Schema_7[A, B, C, D, E, F, Type], P8[_,_,_,_,_,_,_,_]] with Schema_7[A, B, C, D, E, F, Type]
  type Stay[Attr[_, _], Type] = Attr[Schema_6[A, B, C, D, E, F], P7[_,_,_,_,_,_,_]] with Schema_6[A, B, C, D, E, F]
