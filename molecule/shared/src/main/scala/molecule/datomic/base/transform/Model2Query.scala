...
//      case Eq(arg :: Nil) if a.tpe == "Double" && n(arg)     => q.findD(v).where(e, a, Val(arg.toString.drop(5).toDouble)).where(e, a, v)
//      case Eq(arg :: Nil) if a.tpe == "Double"               => q.findD(v).where(e, a, Val(arg.toString.toDouble)).where(e, a, v)
//      case Eq(arg :: Nil) if a.tpe == "BigDecimal" && n(arg) => q.findD(v).where(e, a, Val(BigDecimal(withDecimal(arg.toString.drop(5))))).where(e, a, v)
