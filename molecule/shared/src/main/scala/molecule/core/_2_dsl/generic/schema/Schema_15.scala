...
import molecule.core._2_dsl.boilerplate.base.NS_0_15
...
trait Schema_15[obj[_], props, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O] extends Schema with NS_0_15[obj, props, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O] {
