...
import molecule.core._2_dsl.boilerplate.base.NS_0_16
...
trait Schema_16[obj[_], props, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P] extends Schema with NS_0_16[obj, props, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P] {
