...
import molecule.core._2_dsl.boilerplate.base.NS_0_13
...
trait Schema_13[obj[_], props, A, B, C, D, E, F, G, H, I, J, K, L, M] extends Schema with NS_0_13[obj, props, A, B, C, D, E, F, G, H, I, J, K, L, M] {
