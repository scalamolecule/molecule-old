...
object in3 {
  ...
  trait In_3_0[obj[_], props, In3_0[o[_], _, _, _, _], In3_1[o[_], _, _, _, _, _], In4_0[o[_], _, _, _, _, _], In4_1[o[_], _, _, _, _, _, _], I1, I2, I3]
  ...
  trait In_3_1[obj[_], props, In3_1[o[_], _, _, _, _, _], In3_2[o[_], _, _, _, _, _, _], In4_1[o[_], _, _, _, _, _, _], In4_2[o[_], _, _, _, _, _, _, _], I1, I2, I3, A]
  ...
  trait In_3_2[obj[_], props, In3_2[o[_], _, _, _, _, _, _], In3_3[o[_], _, _, _, _, _, _, _], In4_2[o[_], _, _, _, _, _, _, _], In4_3[o[_], _, _, _, _, _, _, _, _], I1, I2, I3, A, B]
  ...
  trait In_3_3[obj[_], props, In3_3[o[_], _, _, _, _, _, _, _], In3_4[o[_], _, _, _, _, _, _, _, _], In4_3[o[_], _, _, _, _, _, _, _, _], In4_4[o[_], _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C]
  ...
  trait In_3_4[obj[_], props, In3_4[o[_], _, _, _, _, _, _, _, _], In3_5[o[_], _, _, _, _, _, _, _, _, _], In4_4[o[_], _, _, _, _, _, _, _, _, _], In4_5[o[_], _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D]
  ...
  trait In_3_5[obj[_], props, In3_5[o[_], _, _, _, _, _, _, _, _, _], In3_6[o[_], _, _, _, _, _, _, _, _, _, _], In4_5[o[_], _, _, _, _, _, _, _, _, _, _], In4_6[o[_], _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E]
  ...
  trait In_3_6[obj[_], props, In3_6[o[_], _, _, _, _, _, _, _, _, _, _], In3_7[o[_], _, _, _, _, _, _, _, _, _, _, _], In4_6[o[_], _, _, _, _, _, _, _, _, _, _, _], In4_7[o[_], _, _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E, F]
  ...
  trait In_3_7[obj[_], props, In3_7[o[_], _, _, _, _, _, _, _, _, _, _, _], In3_8[o[_], _, _, _, _, _, _, _, _, _, _, _, _], In4_7[o[_], _, _, _, _, _, _, _, _, _, _, _, _], In4_8[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E, F, G]
  ...
  trait In_3_8[obj[_], props, In3_8[o[_], _, _, _, _, _, _, _, _, _, _, _, _], In3_9[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _], In4_8[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _], In4_9[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E, F, G, H]
  ...
  trait In_3_9[obj[_], props, In3_9[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _], In3_10[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_9[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_10[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E, F, G, H, I]
  ...
  trait In_3_10[obj[_], props, In3_10[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _], In3_11[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_10[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_11[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E, F, G, H, I, J]
  ...
  trait In_3_11[obj[_], props, In3_11[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In3_12[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_11[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_12[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E, F, G, H, I, J, K]
  ...
  trait In_3_12[obj[_], props, In3_12[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In3_13[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_12[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_13[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E, F, G, H, I, J, K, L]
  ...
  trait In_3_13[obj[_], props, In3_13[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In3_14[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_13[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_14[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E, F, G, H, I, J, K, L, M]
  ...
  trait In_3_14[obj[_], props, In3_14[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In3_15[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_14[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_15[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E, F, G, H, I, J, K, L, M, N]
  ...
  trait In_3_15[obj[_], props, In3_15[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In3_16[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_15[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_16[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O]
  ...
  trait In_3_16[obj[_], props, In3_16[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In3_17[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_16[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_17[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P]
  ...
  trait In_3_17[obj[_], props, In3_17[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In3_18[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_17[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_18[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q]
  ...
  trait In_3_18[obj[_], props, In3_18[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In3_19[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_18[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], In4_19[o[_], _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], I1, I2, I3, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R]
