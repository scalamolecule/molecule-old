...
private[molecule] trait TreeOps extends Liftables {
  ...
  def nestedTupleClassX(allLevels: Int): Tree = allLevels match {
    case 1 => q""
    case 2 => tq"_root_.molecule.core.macros.nested.NestedTuples.NestedTuples1"
    case 3 => tq"_root_.molecule.core.macros.nested.NestedTuples.NestedTuples2"
    case 4 => tq"_root_.molecule.core.macros.nested.NestedTuples.NestedTuples3"
    case 5 => tq"_root_.molecule.core.macros.nested.NestedTuples.NestedTuples4"
    case 6 => tq"_root_.molecule.core.macros.nested.NestedTuples.NestedTuples5"
    case 7 => tq"_root_.molecule.core.macros.nested.NestedTuples.NestedTuples6"
    case 8 => tq"_root_.molecule.core.macros.nested.NestedTuples.NestedTuples7"
