...
trait Schema_9[A, B, C, D, E, F, G, H, I] extends Schema with OutSchema_9[Schema_9, A, B, C, D, E, F, G, H, I] {
  type Next[Attr[_, _], Type] = Attr[Schema_10[A, B, C, D, E, F, G, H, I, Type], P11[_,_,_,_,_,_,_,_,_,_,_]] with Schema_10[A, B, C, D, E, F, G, H, I, Type]
  type Stay[Attr[_, _], Type] = Attr[Schema_9[A, B, C, D, E, F, G, H, I], P10[_,_,_,_,_,_,_,_,_,_]] with Schema_9[A, B, C, D, E, F, G, H, I]
