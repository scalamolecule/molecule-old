...
trait Schema_15[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O] extends Schema with OutSchema_15[Schema_15, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O] {
  type Next[Attr[_, _], Type] = Attr[Schema_16[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, Type], P17[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_]] with Schema_16[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, Type]
  type Stay[Attr[_, _], Type] = Attr[Schema_15[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O], P16[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_]] with Schema_15[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O]
