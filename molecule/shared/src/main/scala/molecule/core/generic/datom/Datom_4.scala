...
//
//
//trait Datom_4[Obj, Ns4[_,_,_,_,_,_], Ns5[_,_,_,_,_,_,_], In4[_,_,_,_,_,_,_], In5[_,_,_,_,_,_,_,_], A, B, C, D] extends Datom {
//  type Next_[Attr[_, _], Prop, Tpe] = Attr[Ns5[Obj, A, B, C, D, Tpe], In5[_,_,_,_,_,_,_,_]] with Ns5[Obj with Prop, A, B, C, D, Tpe]
//  type Stay_[Attr[_, _]           ] = Attr[Ns4[Obj, A, B, C, D], In4[_,_,_,_,_,_,_]] with Ns4[Obj, A, B, C, D]
//
