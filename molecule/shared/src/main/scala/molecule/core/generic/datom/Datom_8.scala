...
//
//
//trait Datom_8[Obj, Ns8[_,_,_,_,_,_,_,_,_,_], Ns9[_,_,_,_,_,_,_,_,_,_,_], In8[_,_,_,_,_,_,_,_,_,_,_], In9[_,_,_,_,_,_,_,_,_,_,_,_], A, B, C, D, E, F, G, H] extends Datom {
//  type Next_[Attr[_, _], Prop, Tpe] = Attr[Ns9[Obj, A, B, C, D, E, F, G, H, Tpe], In9[_,_,_,_,_,_,_,_,_,_,_,_]] with Ns9[Obj with Prop, A, B, C, D, E, F, G, H, Tpe]
//  type Stay_[Attr[_, _]           ] = Attr[Ns8[Obj, A, B, C, D, E, F, G, H], In8[_,_,_,_,_,_,_,_,_,_,_]] with Ns8[Obj, A, B, C, D, E, F, G, H]
//
