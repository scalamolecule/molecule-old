...
import molecule.core.composition.Tx_0.Tx_0_01
  ...
  with Aggr_01_L0  [o0, p0, A, TxCount_0_1_L0]
{
  ...
  final lazy val db$     : Next[db$    , TxCount_db_    , Option[String]] = ???
  final lazy val basisT$ : Next[basisT$, TxCount_basisT_, Option[Long  ]] = ???

  final lazy val db_     : Stay[db    , TxCount_db    , String] = ???
  final lazy val basisT_ : Stay[basisT, TxCount_basisT, Long  ] = ???

  final def Self: TxCount_0_1_L1[o0, p0, TxCount_, Init, A] with SelfJoin = ???
}
  ...
  with Aggr_01_L1  [o0, p0, o1, p1, A, TxCount_0_1_L1]
{
  ...
  final def Self: TxCount_0_1_L2[o0, p0, o1, p1, TxCount_, Init, A] with SelfJoin = ???
}
  ...
  with Aggr_01_L2  [o0, p0, o1, p1, o2, p2, A, TxCount_0_1_L2]
{
  ...
  final def Self: TxCount_0_1_L3[o0, p0, o1, p1, o2, p2, TxCount_, Init, A] with SelfJoin = ???
}
  ...
  with Aggr_01_L3  [o0, p0, o1, p1, o2, p2, o3, p3, A, TxCount_0_1_L3]
{
  ...
  final def Self: TxCount_0_1_L4[o0, p0, o1, p1, o2, p2, o3, p3, TxCount_, Init, A] with SelfJoin = ???
}
  ...
  with Aggr_01_L4  [o0, p0, o1, p1, o2, p2, o3, p3, o4, p4, A, TxCount_0_1_L4]
{
  ...
  final def Self: TxCount_0_1_L5[o0, p0, o1, p1, o2, p2, o3, p3, o4, p4, TxCount_, Init, A] with SelfJoin = ???
}
  ...
  with Aggr_01_L5  [o0, p0, o1, p1, o2, p2, o3, p3, o4, p4, o5, p5, A, TxCount_0_1_L5]
{
  ...
  final def Self: TxCount_0_1_L6[o0, p0, o1, p1, o2, p2, o3, p3, o4, p4, o5, p5, TxCount_, Init, A] with SelfJoin = ???
}
  ...
  with Aggr_01_L6  [o0, p0, o1, p1, o2, p2, o3, p3, o4, p4, o5, p5, o6, p6, A, TxCount_0_1_L6]
{
  ...
  final def Self: TxCount_0_1_L7[o0, p0, o1, p1, o2, p2, o3, p3, o4, p4, o5, p5, o6, p6, TxCount_, Init, A] with SelfJoin = ???
}
