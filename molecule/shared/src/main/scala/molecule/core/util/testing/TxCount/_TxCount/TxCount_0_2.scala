...
import molecule.core.composition.Tx_0.Tx_0_02
  ...
  with Datom_0_2_L0[o0, p0, A, B, TxCount_0_2_L0, Nothing, Nothing, Nothing]
{
  ...
  final def Self: TxCount_0_2_L1[o0, p0, TxCount_, Init, A, B] with SelfJoin = ???
}
  ...
  with Datom_0_2_L1[o0, p0, o1, p1, A, B, TxCount_0_2_L1, Nothing, Nothing, Nothing]
{
  ...
  final def Self: TxCount_0_2_L2[o0, p0, o1, p1, TxCount_, Init, A, B] with SelfJoin = ???
}
  ...
  with Datom_0_2_L2[o0, p0, o1, p1, o2, p2, A, B, TxCount_0_2_L2, Nothing, Nothing, Nothing]
{
  ...
  final def Self: TxCount_0_2_L3[o0, p0, o1, p1, o2, p2, TxCount_, Init, A, B] with SelfJoin = ???
}
  ...
  with Datom_0_2_L3[o0, p0, o1, p1, o2, p2, o3, p3, A, B, TxCount_0_2_L3, Nothing, Nothing, Nothing]
{
  ...
  final def Self: TxCount_0_2_L4[o0, p0, o1, p1, o2, p2, o3, p3, TxCount_, Init, A, B] with SelfJoin = ???
}
  ...
  with Datom_0_2_L4[o0, p0, o1, p1, o2, p2, o3, p3, o4, p4, A, B, TxCount_0_2_L4, Nothing, Nothing, Nothing]
{
  ...
  final def Self: TxCount_0_2_L5[o0, p0, o1, p1, o2, p2, o3, p3, o4, p4, TxCount_, Init, A, B] with SelfJoin = ???
}
  ...
  with Datom_0_2_L5[o0, p0, o1, p1, o2, p2, o3, p3, o4, p4, o5, p5, A, B, TxCount_0_2_L5, Nothing, Nothing, Nothing]
{
  ...
  final def Self: TxCount_0_2_L6[o0, p0, o1, p1, o2, p2, o3, p3, o4, p4, o5, p5, TxCount_, Init, A, B] with SelfJoin = ???
}
  ...
  with Datom_0_2_L6[o0, p0, o1, p1, o2, p2, o3, p3, o4, p4, o5, p5, o6, p6, A, B, TxCount_0_2_L6, Nothing, Nothing, Nothing]
{
  ...
  final def Self: TxCount_0_2_L7[o0, p0, o1, p1, o2, p2, o3, p3, o4, p4, o5, p5, o6, p6, TxCount_, Init, A, B] with SelfJoin = ???
}
