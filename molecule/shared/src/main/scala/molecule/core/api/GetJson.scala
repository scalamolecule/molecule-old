...
//  *
//  **/
//trait GetJson extends JavaUtil { self: Molecule with JsonBuilder =>
//
//
//  // get ================================================================================================
//
...
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJson(implicit* getAsyncJson]] method.
//    */
...
//    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJson(n:Int)* getAsyncJson]] method.
//    */
...
//    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonAsOf(t:Long)* getAsyncJsonAsOf]] method.
//    */
//  def getJsonAsOf(t: Long)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(AsOf(TxLong(t))), -1)
//
//
...
//    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonAsOf(t:Long,n:Int)* getAsyncJsonAsOf]] method.
//    */
//  def getJsonAsOf(t: Long, n: Int)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(AsOf(TxLong(t))), n)
//
//
...
//    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonAsOf(tx:molecule\.datomic\.base\.facade\.TxReport)* getAsyncJsonAsOf]] method.
//    */
//  def getJsonAsOf(tx: TxReport)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(AsOf(TxLong(tx.t))), -1)
//
//
...
//    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonAsOf(tx:molecule\.datomic\.base\.facade\.TxReport,n:Int)* getAsyncJsonAsOf]] method.
//    */
//  def getJsonAsOf(tx: TxReport, n: Int)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(AsOf(TxLong(tx.t))), n)
//
//
...
//    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonAsOf(date:java\.util\.Date)* getAsyncJsonAsOf]] method.
//    */
//  def getJsonAsOf(date: java.util.Date)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(AsOf(TxDate(date))), -1)
//
//
//  /** Get json data for n rows matching molecule as of tx.
//    * <br><br>
...
//    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonAsOf(date:java\.util\.Date,n:Int)* getAsyncJsonAsOf]] method.
//    */
//  def getJsonAsOf(date: java.util.Date, n: Int)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(AsOf(TxDate(date))), n)
//
//
//  // get since ================================================================================================
//
...
//    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonSince(t:Long)* getAsyncJsonSince]] method.
//    */
//  def getJsonSince(t: Long)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(Since(TxLong(t))), -1)
//
//
...
//    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonSince(t:Long,n:Int)* getAsyncJsonSince]] method.
//    */
//  def getJsonSince(t: Long, n: Int)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(Since(TxLong(t))), n)
//
//
...
//    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonSince(tx:molecule\.datomic\.base\.facade\.TxReport)* getAsyncJsonSince]] method.
//    */
//  def getJsonSince(tx: TxReport)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(Since(TxLong(tx.t))), -1)
//
//
...
//    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonSince(tx:molecule\.datomic\.base\.facade\.TxReport,n:Int)* getAsyncJsonSince]] method.
//    */
//  def getJsonSince(tx: TxReport, n: Int)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(Since(TxLong(tx.t))), n)
//
//
...
//    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonSince(date:java\.util\.Date)* getAsyncJsonSince]] method.
//    */
//  def getJsonSince(date: java.util.Date)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(Since(TxDate(date))), -1)
//
//
...
//    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonSince(date:java\.util\.Date,n:Int)* getAsyncJsonSince]] method.
//    */
//  def getJsonSince(date: java.util.Date, n: Int)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(Since(TxDate(date))), n)
//
//
//  // get with ================================================================================================
//
...
//    * @param conn        Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonWith(txMolecules* getAsyncJsonWith]] method.
//    */
//  def getJsonWith(txMolecules: Seq[Seq[Statement]]*)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(With(toJavaList(txMolecules.flatten.flatten.map(_.toJava)))), -1)
//
//
//  /** Get json data for all rows matching molecule with applied molecule transaction data.
//    * <br><br>
...
//    * @param conn        Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonWith(n:Int,txMolecules* getAsyncJsonWith]] method.
//    */
//  def getJsonWith(n: Int, txMolecules: Seq[Seq[Statement]]*)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(With(toJavaList(txMolecules.flatten.flatten.map(_.toJava)))), n)
//
//
...
//    * @param conn   Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonWith(txData:java\.util\.List[_])* getAsyncJsonWith]] method.
//    */
//  def getJsonWith(txData: java.util.List[_])(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(With(txData.asInstanceOf[jList[jList[_]]])), -1)
//
//
...
//    * @param conn   Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
//    * @return String of json
//    * @see Equivalent asynchronous [[molecule.core.api.GetAsyncJson.getAsyncJsonWith(txData:java\.util\.List[_],n:Int)* getAsyncJsonWith]] method.
//    */
//  def getJsonWith(txData: java.util.List[_], n: Int)(implicit conn: Conn): String =
//    buildJson(conn.usingTempDb(With(txData.asInstanceOf[jList[jList[_]]])), n)
//
//
//  // get history ================================================================================================
//
...
//  protected def buildJson(conn: Conn, n: Int): String = {
