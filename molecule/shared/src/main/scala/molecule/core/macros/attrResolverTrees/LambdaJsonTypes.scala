...
private[molecule] trait LambdaJsonTypes extends TreeOps {
  ...
  val jsonOptAttr: richTree => (Int, Int) => Tree = (t: richTree) => {
  ...
  val jsonOptApplyAttr: richTree => (Int, Int) => Tree = (t: richTree) => {
    val field = t.nameClean
    if (t.card == 1) {
      t.tpeS match {
  ...
  val jsonOptRefAttr: richTree => (Int, Int) => Tree = (t: richTree) => {
    val field = t.nameClean
    if (t.card == 1) {
  ...
  val jsonOptMapAttr: richTree => (Int, Int) => Tree = (t: richTree) => {
    val field = t.nameClean
    t.tpeS match {
  ...
  val jsonOptApplyMapAttr: richTree => (Int, Int) => Tree = (t: richTree) => {
    val field = t.nameClean
    t.tpeS match {
