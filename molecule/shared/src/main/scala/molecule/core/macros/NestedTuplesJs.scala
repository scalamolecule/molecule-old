...
//trait NestedTuplesJs[Obj, OuterTpl] extends jComparator[jList[AnyRef]] { self: Molecule_0[Obj, OuterTpl] =>
//
...
//      for {
//        conn <- conn
//        data <- conn.queryJs(_nestedQuery.get, -1, indexes, qr2tpl)
//      } yield {
//        resetCastVars
