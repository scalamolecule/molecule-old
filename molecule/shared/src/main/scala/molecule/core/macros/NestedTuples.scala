...
trait NestedTuples[Obj, OuterTpl] extends jComparator[jList[AnyRef]] { self: Molecule_0[Obj, OuterTpl] =>
  ...
  final override def getIterable(implicit conn: Future[Conn], ec: ExecutionContext): Future[Iterable[OuterTpl]] = get(conn, ec)
  ...
  /**
    ...
    * @return Iterable[Obj]
    */
  final override def getObjIterable(implicit conn: Future[Conn], ec: ExecutionContext): Future[Iterable[Obj]] = {
  ...
  final override def getObjList(implicit conn: Future[Conn], ec: ExecutionContext): Future[List[Obj]] = {
