...
import scala.collection.{Iterable, Iterator, Map, Seq, Set, concurrent, mutable}
import scala.language.implicitConversions


@deprecated("Use `scala.jdk.CollectionConverters` instead", "2.13.0")
trait JavaConversions extends AsJavaConverters with AsScalaConverters {
...
object JavaConverters extends JavaConversions
