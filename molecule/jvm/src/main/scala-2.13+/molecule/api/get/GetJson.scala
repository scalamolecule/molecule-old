...
trait GetJson { self: MoleculeBase with JsonBuilder =>
  ...
  /** Get json data for all rows matching molecule.
    ...
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJson(implicit* getAsyncJson]] method.
    */
  ...
  /** Get json data for n rows matching molecule
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/crud/getjson/ Manual on getJson]]
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJson(n:Int)* getAsyncJson]] method.
    */
  ...
  /** Get json data for all rows matching molecule as of transaction time `t`.
    ...
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonAsOf(t:Long)* getAsyncJsonAsOf]] method.
    */
  ...
  /** Get json data for n rows matching molecule as of transaction time `t`.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonAsOf(t:Long,n:Int)* getAsyncJsonAsOf]] method.
    */
  ...
  /** Get json data for all rows matching molecule as of tx.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonAsOf(tx:molecule\.facade\.TxReport)* getAsyncJsonAsOf]] method.
    */
  def getJsonAsOf(tx: molecule.facade.TxReport)(implicit conn: Conn): String =
  ...
  /** Get json data for n rows matching molecule as of tx.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonAsOf(tx:molecule\.facade\.TxReport,n:Int)* getAsyncJsonAsOf]] method.
    */
  def getJsonAsOf(tx: molecule.facade.TxReport, n: Int)(implicit conn: Conn): String =
  ...
  /** Get json data for all rows matching molecule as of date.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonAsOf(date:java\.util\.Date)* getAsyncJsonAsOf]] method.
    */
  ...
  /** Get json data for n rows matching molecule as of tx.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonAsOf(date:java\.util\.Date,n:Int)* getAsyncJsonAsOf]] method.
    */
  ...
  /** Get json data for all rows matching molecule since transaction time `t`.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonSince(t:Long)* getAsyncJsonSince]] method.
    */
  ...
  /** Get json data for n rows matching molecule since transaction time `t`.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonSince(t:Long,n:Int)* getAsyncJsonSince]] method.
    */
  ...
  /** Get json data for all rows matching molecule since tx.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonSince(tx:molecule\.facade\.TxReport)* getAsyncJsonSince]] method.
    */
  def getJsonSince(tx: molecule.facade.TxReport)(implicit conn: Conn): String =
  ...
  /** Get json data for n rows matching molecule since tx.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonSince(tx:molecule\.facade\.TxReport,n:Int)* getAsyncJsonSince]] method.
    */
  def getJsonSince(tx: molecule.facade.TxReport, n: Int)(implicit conn: Conn): String =
  ...
  /** Get json data for all rows matching molecule since date.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonSince(date:java\.util\.Date)* getAsyncJsonSince]] method.
    */
  ...
  /** Get json data for n rows matching molecule since date.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonSince(date:java\.util\.Date,n:Int)* getAsyncJsonSince]] method.
    */
  ...
  /** Get json data for all rows matching molecule with applied molecule transaction data.
    ...
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonWith(txMolecules* getAsyncJsonWith]] method.
    */
  ...
  /** Get json data for all rows matching molecule with applied molecule transaction data.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/with/ Manual]] on `with`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonWith(n:Int,txMolecules* getAsyncJsonWith]] method.
    */
  ...
  /** Get json data for all rows matching molecule with applied raw transaction data.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/with/ Manual]] on `with`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonWith(txData:java\.util\.List[_])* getAsyncJsonWith]] method.
    */
  ...
  /** Get json data for n rows matching molecule with applied raw transaction data.
    ...
    * @return String of json
    * @see [[http://www.scalamolecule.org/manual/time/with/ Manual]] on `with`
    * @see Equivalent asynchronous [[molecule.api.getAsync.GetAsyncJson.getAsyncJsonWith(txData:java\.util\.List[_],n:Int)* getAsyncJsonWith]] method.
    */
