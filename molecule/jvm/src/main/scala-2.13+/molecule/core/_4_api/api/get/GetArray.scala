...
trait GetArray[Obj, Tpl] { self: Molecule[Obj, Tpl] =>
  ...
  /** Get `Array` of all rows as tuples matching molecule.
    ...
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArray(implicit* getAsyncArray]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of types matching the attributes of the molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArray(n:Int)* getAsyncArray]] method.
    */
  ...
  /** Get `Array` of all rows as tuples matching molecule as of transaction time `t`.
    ...
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArrayAsOf(t:Long)* getAsyncArrayAsOf]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule as of transaction time `t`.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArrayAsOf(t:Long,n:Int)* getAsyncArrayAsOf]] method.
    */
  ...
  /** Get `Array` of all rows as tuples matching molecule as of tx.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArrayAsOf(tx:molecule\.datomic\.base\.facade\.TxReport)* getAsyncArrayAsOf]] method.
    **/
  ...
  /** Get `Array` of n rows as tuples matching molecule as of tx.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArrayAsOf(tx:molecule\.datomic\.base\.facade\.TxReport,n:Int)* getAsyncArrayAsOf]] method.
    **/
  ...
  /** Get `Array` of all rows as tuples matching molecule as of date.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArrayAsOf(date:java\.util\.Date)* getAsyncArrayAsOf]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule as of date.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArrayAsOf(date:java\.util\.Date,n:Int)* getAsyncArrayAsOf]] method.
    */
  ...
  /** Get `Array` of all rows as tuples matching molecule since transaction time `t`.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArraySince(t:Long)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule since transaction time `t`.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArraySince(t:Long,n:Int)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of all rows as tuples matching molecule since tx.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArraySince(tx:molecule\.datomic\.base\.facade\.TxReport)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule since tx.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArraySince(tx:molecule\.datomic\.base\.facade\.TxReport,n:Int)* getAsyncArraySince]] method.
    **/
  ...
  /** Get `Array` of all rows as tuples matching molecule since date.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArraySince(date:java\.util\.Date)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule since date.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArraySince(date:java\.util\.Date,n:Int)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of all rows as tuples matching molecule with applied molecule transaction data.
    ...
    * @param tplType     Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArrayWith(txMolecules* getAsyncArrayWith]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule with applied molecule transaction data.
    ...
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArrayWith(n:Int,txMolecules* getAsyncArrayWith]] method.
    */
  ...
  /** Get `Array` of all rows as tuples matching molecule with applied raw transaction data.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArrayWith(txData:java\.util\.List[_])* getAsyncArrayWith]] method.
    */
  ...
  /** Get `Array` of n rows as tuples matching molecule with applied raw transaction data.
    ...
    * @param tplType Implicit `ClassTag[Tpl]` to capture Tuple type for Array
    * @return Array[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncArray.getAsyncArrayWith(txData:java\.util\.List[_],n:Int)* getAsyncArrayWith]] method.
    */
