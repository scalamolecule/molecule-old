...
trait GetRaw { self: MoleculeBase =>
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule.
    ...
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRaw(implicit* getAsyncRaw]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRaw(n:Int)* getAsyncRaw]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule as of transaction time `t`.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawAsOf(t:Long)* getAsyncRawAsOf]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule as of transaction time `t`.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawAsOf(t:Long,n:Int)* getAsyncRawAsOf]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule as of tx.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawAsOf(tx:molecule\.datomic\.base\.facade\.TxReport)* getAsyncRawAsOf]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule as of tx.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawAsOf(tx:molecule\.datomic\.base\.facade\.TxReport,n:Int)* getAsyncRawAsOf]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule as of date.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawAsOf(date:java\.util\.Date)* getAsyncRawAsOf]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule as of date.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawAsOf(date:java\.util\.Date,n:Int)* getAsyncRawAsOf]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule since transaction time `t`.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawSince(t:Long)* getAsyncRawSince]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule since transaction time `t`.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawSince(t:Long,n:Int)* getAsyncRawSince]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule since tx.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawSince(tx:molecule\.datomic\.base\.facade\.TxReport)* getAsyncRawSince]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule since tx.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawSince(tx:molecule\.datomic\.base\.facade\.TxReport,n:Int)* getAsyncRawSince]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule since date.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawSince(date:java\.util\.Date)* getAsyncRawSince]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule since date.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawSince(date:java\.util\.Date,n:Int)* getAsyncRawSince]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule with applied molecule transaction data.
    ...
    * @param conn        Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawWith(txMolecules* getAsyncRawWith]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule with applied molecule transaction data.
    ...
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawWith(n:Int,txMolecules* getAsyncRawWith]] method.
    */
  ...
  /** Get `java.util.Collection` of all untyped rows matching molecule with applied raw transaction data.
    ...
    * @param conn   Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawWith(txData:java\.util\.List[_])* getAsyncRawWith]] method.
    */
  ...
  /** Get `java.util.Collection` of n untyped rows matching molecule with applied raw transaction data.
    ...
    * @param conn   Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return `java.util.Collection[java.util.List[AnyRef]]`
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncRaw.getAsyncRawWith(txData:java\.util\.List[_],n:Int)* getAsyncRawWith]] method.
    */
