...
import molecule.core._3_dsl2molecule.ops.exception.LiftablesException
...
private[molecule] trait Liftables extends MacroHelpers {
  ...
  implicit val liftQuery: c.universe.Liftable[Query] = Liftable[Query] { q => q"import molecule.core.ast.query._; Query(${q.f}, ${q.wi}, ${q.i}, ${q.wh})" }
