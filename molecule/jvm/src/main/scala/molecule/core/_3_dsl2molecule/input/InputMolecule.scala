...
/** Shared interface of all input molecules.
  ...
  * <br><br>
  * Input molecules can await 1, 2 or 3 inputs and are constructed by applying the [[molecule.core._2_dsl.expression.AttrExpressions.? ?]] marker
  ...
  * an [[molecule.core._3_dsl2molecule.input.InputMolecule_1 InputMolecule_3]] and 3 an [[molecule.core._3_dsl2molecule.input.InputMolecule_3 InputMolecule_3]].
  * <br><br>
