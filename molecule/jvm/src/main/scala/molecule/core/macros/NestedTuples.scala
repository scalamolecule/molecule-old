...
object NestedTuples {
  ...
  trait NestedTuples3[Obj, OuterTpl] extends NestedTuples[Obj, OuterTpl] with jComparator[jList[AnyRef]] { self: Molecule_0[Obj, OuterTpl] =>
  ...
  trait NestedTuples4[Obj, OuterTpl] extends NestedTuples[Obj, OuterTpl] with jComparator[jList[AnyRef]] { self: Molecule_0[Obj, OuterTpl] =>
  ...
  trait NestedTuples5[Obj, OuterTpl] extends NestedTuples[Obj, OuterTpl] with jComparator[jList[AnyRef]] { self: Molecule_0[Obj, OuterTpl] =>
  ...
  trait NestedTuples6[Obj, OuterTpl] extends NestedTuples[Obj, OuterTpl] with jComparator[jList[AnyRef]] { self: Molecule_0[Obj, OuterTpl] =>
  ...
  trait NestedTuples7[Obj, OuterTpl] extends NestedTuples[Obj, OuterTpl] with jComparator[jList[AnyRef]] { self: Molecule_0[Obj, OuterTpl] =>
