...
object Molecule {
  ...
  abstract class Molecule01[Obj, A](val _model: Model, queryData: (Query, Option[Query], Query, Option[Query])) extends Molecule[Obj, A] {
    ...
    /** See [[molecule.core._4_api.api.Molecule.insert insert]] */
    ...
    /** See [[molecule.core._4_api.api.Molecule.insertAsync insertAsync]] */
    ...
    /** See [[molecule.core._4_api.api.Molecule.inspectInsert inspectInsert]] */
    ...
    /** See [[molecule.core._4_api.api.Molecule.getInsertStmts getInsertStmts]] */
