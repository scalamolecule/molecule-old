...
trait Schema_16[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P] extends Schema with OutSchema_16[Schema_16, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P] {
  type Next[Attr[_, _], Type] = Attr[Schema_17[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Type], P18[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_]] with Schema_17[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Type]
  type Stay[Attr[_, _], Type] = Attr[Schema_16[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P], P17[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_]] with Schema_16[A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P]
