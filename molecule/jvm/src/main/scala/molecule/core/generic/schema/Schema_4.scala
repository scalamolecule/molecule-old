...
trait Schema_4[A, B, C, D] extends Schema with OutSchema_4[Schema_4, A, B, C, D] {
  type Next[Attr[_, _], Type] = Attr[Schema_5[A, B, C, D, Type], P6[_,_,_,_,_,_]] with Schema_5[A, B, C, D, Type]
  type Stay[Attr[_, _], Type] = Attr[Schema_4[A, B, C, D], P5[_,_,_,_,_]] with Schema_4[A, B, C, D]
