...
//  *
//  */
//object AjaxResponder2 extends App with Serializations {
...
//            case Right(futByteBufferResult) => futByteBufferResult
//              .map { byteBufferResult =>
//                val dataLength                    = byteBufferResult.remaining()
//                val bytesAsByteArray: Array[Byte] = Array.ofDim[Byte](dataLength + 1)
//
//                // Reserve first byte for exception flag
//                byteBufferResult.get(bytesAsByteArray, 1, dataLength)
//
