...
trait GetAsyncJson { self: MoleculeBase with GetJson with JsonBuilder =>
  ...
  /** Get `Future` with json data for all rows matching molecule as of tx.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.core.api.get.GetJson.getJsonAsOf(tx:molecule\.facade\.TxReport)* getJsonAsOf]] method.
    *
    * @group getAsyncJsonAsOf
    ...
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    */
  def getAsyncJsonAsOf(tx: molecule.core.facade.TxReport)(implicit conn: Conn): Future[String] =
  ...
  /** Get `Future` with json data for n rows matching molecule as of tx.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.core.api.get.GetJson.getJsonAsOf(tx:molecule\.facade\.TxReport,n:Int)* getJsonAsOf]] method.
    *
    * @group getAsyncJsonAsOf
    * @param tx   [[molecule.core.facade.TxReport TxReport]] (returned from all molecule transaction operations)
    * @param n    Int Number of rows returned
    ...
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    */
  def getAsyncJsonAsOf(tx: molecule.core.facade.TxReport, n: Int)(implicit conn: Conn): Future[String] =
  ...
  /** Get `Future` with json data for all rows matching molecule since tx.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.core.api.get.GetJson.getJsonSince(tx:molecule\.facade\.TxReport)* getJsonSince]] method.
    *
    * @group getAsyncJsonSince
    * @param tx   [[molecule.core.facade.TxReport TxReport]] (returned from all molecule transaction operations)
    * @param conn Implicit [[molecule.core.facade.Conn Conn]] value in scope
    ...
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    */
  def getAsyncJsonSince(tx: molecule.core.facade.TxReport)(implicit conn: Conn): Future[String] =
  ...
  /** Get `Future` with json data for n rows matching molecule since tx.
    ...
    * <br><br>
    * For more info and code examples see equivalent synchronous
    * [[molecule.core.api.get.GetJson.getJsonSince(tx:molecule\.facade\.TxReport,n:Int)* getJsonSince]] method.
    *
    * @group getAsyncJsonSince
    * @param tx   [[molecule.core.facade.TxReport TxReport]] (returned from all molecule transaction operations)
    * @param n    Int Number of rows returned
    ...
    * @see [[http://www.scalamolecule.org/manual/time/asof-since/ Manual]] on `asof`/`since`
    */
  def getAsyncJsonSince(tx: molecule.core.facade.TxReport, n: Int)(implicit conn: Conn): Future[String] =
