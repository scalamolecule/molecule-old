...
{
  override type Next[Attr[_, _], Prop, Tpe] = Attr[TxCount_0_2_L0[o0, p0 with Prop, A, Tpe], Nothing] with TxCount_0_2_L0[o0, p0 with Prop, A, Tpe]
  override type Stay[Attr[_, _], Prop, Tpe] = Attr[TxCount_0_1_L0[o0, p0          , A     ], Nothing] with TxCount_0_1_L0[o0, p0          , A     ]
...
{
  override type Next[Attr[_, _], Prop, Tpe] = Attr[TxCount_0_2_L1[o0, p0, o1, p1 with Prop, A, Tpe], Nothing] with TxCount_0_2_L1[o0, p0, o1, p1 with Prop, A, Tpe]
  override type Stay[Attr[_, _], Prop, Tpe] = Attr[TxCount_0_1_L1[o0, p0, o1, p1          , A     ], Nothing] with TxCount_0_1_L1[o0, p0, o1, p1          , A     ]
...
{
  override type Next[Attr[_, _], Prop, Tpe] = Attr[TxCount_0_2_L2[o0, p0, o1, p1, o2, p2 with Prop, A, Tpe], Nothing] with TxCount_0_2_L2[o0, p0, o1, p1, o2, p2 with Prop, A, Tpe]
  override type Stay[Attr[_, _], Prop, Tpe] = Attr[TxCount_0_1_L2[o0, p0, o1, p1, o2, p2          , A     ], Nothing] with TxCount_0_1_L2[o0, p0, o1, p1, o2, p2          , A     ]
