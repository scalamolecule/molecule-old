...
trait TxCount_0 extends TxCount {
  private type Next[Attr[_, _], Prop, Tpe] = Attr[TxCount_1[Prop, Tpe], D02[_,_,_]] with TxCount_1[Prop, Tpe]
  private type Stay[Attr[_, _], Prop, Tpe] = Attr[TxCount_0, D01[_,_]] with TxCount_0
