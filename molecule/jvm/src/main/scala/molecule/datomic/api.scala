...
import molecule.core._4_api.api.{Keywords, TxBundles, TxFunctions}
import molecule.core._2_dsl.expression.LogicImplicits
import molecule.core._3_dsl2molecule.factory._
import molecule.core._2_dsl.generic.{GenericLog, GenericSchema}
import molecule.core._2_dsl.generic.index.{GenericAEVT, GenericAVET, GenericEAVT, GenericVAET}
...
/** Molecule API to be imported into your project to use Molecule with the Datomic Peer API.
  ...
  *
  *  - Define your schema: [[molecule.core._1_dataModel.data.model Docs]]
