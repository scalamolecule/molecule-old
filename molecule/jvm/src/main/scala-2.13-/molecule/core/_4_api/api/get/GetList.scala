...
/** Default data getter methods on molecules that return List[Tpl].
  ...
  * */
trait GetList[Tpl] extends GetArray[Tpl] with Quoted { self: Molecule[Obj, Tpl] =>
  ...
  /** Get `List` of all rows as tuples matching molecule.
    ...
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsync(implicit* getAsync]] method.
    */
  ...
  /** Get `List` of n rows as tuples matching molecule.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of types matching the attributes of the molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsync(n:Int)* getAsync]] method.
    */
  ...
  /** Get `List` of all rows as tuples matching molecule as of transaction time `t`.
    ...
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncAsOf(t:Long)* getAsyncAsOf]] method.
    */
  ...
  /** Get `List` of n rows as tuples matching molecule as of transaction time `t`.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncAsOf(t:Long,n:Int)* getAsyncAsOf]] method.
    */
  ...
  /** Get `List` of all rows as tuples matching molecule as of tx.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncAsOf(tx:molecule\.datomic\.base\.facade\.TxReport)* getAsyncAsOf]] method.
    **/
  ...
  /** Get `List` of n rows as tuples matching molecule as of tx.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncAsOf(tx:molecule\.datomic\.base\.facade\.TxReport,n:Int)* getAsyncAsOf]] method.
    **/
  ...
  /** Get `List` of all rows as tuples matching molecule as of date.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncAsOf(date:java\.util\.Date)* getAsyncAsOf]] method.
    */
  ...
  /** Get `List` of n rows as tuples matching molecule as of date.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncAsOf(date:java\.util\.Date,n:Int)* getAsyncAsOf]] method.
    */
  ...
  /** Get `List` of all rows as tuples matching molecule since transaction time `t`.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncSince(t:Long)* getAsyncSince]] method.
    */
  ...
  /** Get `List` of n rows as tuples matching molecule since transaction time `t`.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncSince(t:Long,n:Int)* getAsyncSince]] method.
    */
  ...
  /** Get `List` of all rows as tuples matching molecule since tx.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncSince(tx:molecule\.datomic\.base\.facade\.TxReport)* getAsyncSince]] method.
    */
  ...
  /** Get `List` of n rows as tuples matching molecule since tx.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncSince(tx:molecule\.datomic\.base\.facade\.TxReport,n:Int)* getAsyncSince]] method.
    */
  ...
  /** Get `List` of all rows as tuples matching molecule since date.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncSince(date:java\.util\.Date)* getAsyncSince]] method.
    */
  ...
  /** Get `List` of n rows as tuples matching molecule since date.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncSince(date:java\.util\.Date,n:Int)* getAsyncSince]] method.
    */
  ...
  /** Get `List` of all rows as tuples matching molecule with applied molecule transaction data.
    ...
    * @param conn        Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncWith(txMolecules* getAsyncWith]] method.
    */
  ...
  /** Get `List` of n rows as tuples matching molecule with applied molecule transaction data.
    ...
    * @param conn        Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncWith(n:Int,txMolecules* getAsyncWith]] method.
    */
  ...
  /** Get `List` of all rows as tuples matching molecule with applied raw transaction data.
    ...
    * @param conn   Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncWith(txData:java\.util\.List[_])* getAsyncWith]] method.
    */
  ...
  /** Get `List` of n rows as tuples matching molecule with applied raw transaction data.
    ...
    * @param conn   Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncWith(txData:java\.util\.List[_],n:Int)* getAsyncWith]] method.
    */
  ...
  /** Get history of operations as `List` on an attribute in the db.
    ...
    * @param conn Implicit [[molecule.datomic.base.facade.Conn Conn]] value in scope
    * @return List[Tpl] where Tpl is a tuple of data matching molecule
    * @see Equivalent asynchronous [[molecule.core._4_api.api.getAsync.GetAsyncList.getAsyncHistory(implicit* getAsyncHistory]] method.
    */
