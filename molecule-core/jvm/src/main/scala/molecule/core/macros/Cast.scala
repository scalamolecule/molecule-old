...
private[molecule] trait Cast extends CastAggr {
  ...
  val castManyAttr: String => Int => Tree = {
    ...
    case "Date"       => (i: Int) => q"castMany[Date](row, $i)"
    case "UUID"       => (i: Int) => q"castMany[UUID](row, $i)"
    case "URI"        => (i: Int) => q"castManyURI(row, $i)"
  ...
  val castOptionalAttr: richTree => Int => Tree = (t: richTree) =>
    if (t.card == 1) {
      ...
      t.tpeS match {
        ...
        case "Date"       => (i: Int) => q"castOptOne[Date](row, $i)"
        case "UUID"       => (i: Int) => q"castOptOne[UUID](row, $i)"
        case "URI"        => (i: Int) => q"castOptOneURI(row, $i)"
      ...
      t.tpeS match {
        ...
        case "Date"       => (i: Int) => q"castOptMany[Date](row, $i)"
        case "UUID"       => (i: Int) => q"castOptMany[UUID](row, $i)"
        case "URI"        => (i: Int) => q"castOptManyURI(row, $i)"
  ...
  val castOptionalApplyAttr: richTree => Int => Tree = (t: richTree) => if (t.card == 1) {
    ...
    t.tpeS match {
      ...
      case "Date"       => (i: Int) => q"castOptOneApply[Date](row, $i)"
      case "UUID"       => (i: Int) => q"castOptOneApply[UUID](row, $i)"
      case "URI"        => (i: Int) => q"castOptOneApplyURI(row, $i)"
    ...
    t.tpeS match {
      ...
      case "Date"       => (i: Int) => q"castOptManyApply[Date](row, $i)"
      case "UUID"       => (i: Int) => q"castOptManyApply[UUID](row, $i)"
      case "URI"        => (i: Int) => q"castOptManyApplyURI(row, $i)"
  ...
  val castMandatoryMapAttr: richTree => Int => Tree = (t: richTree) => t.tpeS match {
    ...
    case "Date"       => (i: Int) => q"castMapDate(row, $i)"
    case "UUID"       => (i: Int) => q"castMapUUID(row, $i)"
    case "URI"        => (i: Int) => q"castMapURI(row, $i)"
  ...
  val castOptionalMapAttr: richTree => Int => Tree = (t: richTree) => t.tpeS match {
    ...
    case "Date"       => (i: Int) => q"castOptMapDate(row, $i)"
    case "UUID"       => (i: Int) => q"castOptMapUUID(row, $i)"
    case "URI"        => (i: Int) => q"castOptMapURI(row, $i)"
  ...
  val castOptionalMapApplyAttr: richTree => Int => Tree = (t: richTree) => t.tpeS match {
    ...
    case "Date"       => (i: Int) => q"castOptMapApplyDate(row, $i)"
    case "UUID"       => (i: Int) => q"castOptMapApplyUUID(row, $i)"
    case "URI"        => (i: Int) => q"castOptMapApplyURI(row, $i)"
  ...
  val castKeyedMapAttr: String => Int => Tree = {
    ...
    case "Date"       => (i: Int) => q"molecule.core.util.fns.str2date(row.get($i).toString)"
    case "UUID"       => (i: Int) => q"java.util.UUID.fromString(row.get($i).toString)"
    case "URI"        => (i: Int) => q"new java.net.URI(row.get($i).toString)"
