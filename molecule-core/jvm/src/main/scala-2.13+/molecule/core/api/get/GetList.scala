...
trait GetList[Obj, Tpl] extends GetArray[Obj, Tpl] with Quoted { self: Molecule_0[Obj, Tpl] =>
  ...
  /** Get `List` of rows as tuples matching molecule as of transaction time `t`.
    * <br><br>
  ...
  /** Get `List` of rows as tuples matching molecule as of tx.
    * <br><br>
    ...
    * */
  def getAsOf(tx: TxReport, n: Int = -1)(implicit conn: Conn): List[Tpl] =
    get(n)(conn.usingTempDb(AsOf(TxLong(tx.t))))


  /** Get `List` of rows as tuples matching molecule as of date.
    * <br><br>
    ...
    */
  def getAsOf(date: Date, n: Int = -1)(implicit conn: Conn): List[Tpl] =
    get(n)(conn.usingTempDb(AsOf(TxDate(date))))


  // get since ================================================================================================

  /** Get `List` of rows as tuples matching molecule since transaction time `t`.
    * <br><br>
    * Transaction time `t` is an auto-incremented transaction number assigned internally by Datomic.
    * <br><br>
    ...
    */
  def getSince(t: Long, n: Int = -1)(implicit conn: Conn): List[Tpl] =
    get(n)(conn.usingTempDb(Since(TxLong(t))))


  /** Get `List` of rows as tuples matching molecule since tx.
    * <br><br>
    ...
    */
  def getSince(tx: TxReport, n: Int = -1)(implicit conn: Conn): List[Tpl] =
    get(n)(conn.usingTempDb(Since(TxLong(tx.t))))


  /** Get `List` of rows as tuples matching molecule since date.
    * <br><br>
    ...
    */
  def getSince(date: Date, n: Int = -1)(implicit conn: Conn): List[Tpl] =
  ...
  /** Get `List` of rows as tuples matching molecule with applied raw transaction data.
    * <br><br>
    ...
    */
  def getWith(txData: java.util.List[_], n: Int = -1)(implicit conn: Conn): List[Tpl] =
