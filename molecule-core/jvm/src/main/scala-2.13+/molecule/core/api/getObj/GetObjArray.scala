...
import molecule.core.api.getAsyncObj.GetAsyncObjArray
...
trait GetObjArray[Obj, Tpl] { self: Molecule_0[Obj, Tpl] =>
  ...
  /** Get `Array` of all rows as objects matching molecule.
    ...
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArray(implicit* getAsyncObjArray]] method.
    */
  ...
  /** Get `Array` of n rows as objects matching molecule.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of types matching the attributes of the molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArray(n:Int)* getAsyncArray]] method.
    */
  ...
  /** Get `Array` of all rows as objects matching molecule as of transaction time `t`.
    ...
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArrayAsOf(t:Long)* getAsyncArrayAsOf]] method.
    */
  ...
  /** Get `Array` of n rows as objects matching molecule as of transaction time `t`.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArrayAsOf(t:Long,n:Int)* getAsyncArrayAsOf]] method.
    */
  ...
  /** Get `Array` of all rows as objects matching molecule as of tx.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArrayAsOf(tx:molecule\.datomic\.base\.facade\.TxReport)* getAsyncArrayAsOf]] method.
    **/
  ...
  /** Get `Array` of n rows as objects matching molecule as of tx.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArrayAsOf(tx:molecule\.datomic\.base\.facade\.TxReport,n:Int)* getAsyncArrayAsOf]] method.
    **/
  ...
  /** Get `Array` of all rows as objects matching molecule as of date.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArrayAsOf(date:java\.util\.Date)* getAsyncArrayAsOf]] method.
    */
  ...
  /** Get `Array` of n rows as objects matching molecule as of date.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArrayAsOf(date:java\.util\.Date,n:Int)* getAsyncArrayAsOf]] method.
    */
  ...
  /** Get `Array` of all rows as objects matching molecule since transaction time `t`.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArraySince(t:Long)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of n rows as objects matching molecule since transaction time `t`.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArraySince(t:Long,n:Int)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of all rows as objects matching molecule since tx.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArraySince(tx:molecule\.datomic\.base\.facade\.TxReport)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of n rows as objects matching molecule since tx.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArraySince(tx:molecule\.datomic\.base\.facade\.TxReport,n:Int)* getAsyncArraySince]] method.
    **/
  ...
  /** Get `Array` of all rows as objects matching molecule since date.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArraySince(date:java\.util\.Date)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of n rows as objects matching molecule since date.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArraySince(date:java\.util\.Date,n:Int)* getAsyncArraySince]] method.
    */
  ...
  /** Get `Array` of all rows as objects matching molecule with applied molecule transaction data.
    ...
    * @param tplType     Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArrayWith(txMolecules* getAsyncArrayWith]] method.
    */
  ...
  /** Get `Array` of n rows as objects matching molecule with applied molecule transaction data.
    ...
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArrayWith(n:Int,txMolecules* getAsyncArrayWith]] method.
    */
  ...
  /** Get `Array` of all rows as objects matching molecule with applied raw transaction data.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArrayWith(txData:java\.util\.List[_])* getAsyncArrayWith]] method.
    */
  ...
  /** Get `Array` of n rows as objects matching molecule with applied raw transaction data.
    ...
    * @param tplType Implicit `ClassTag[Obj]` to capture the object type for Array
    * @return Array[Obj] where Obj is an object of data matching molecule
    * @see Equivalent asynchronous [[GetAsyncObjArray.getAsyncObjArrayWith(txData:java\.util\.List[_],n:Int)* getAsyncArrayWith]] method.
    */
