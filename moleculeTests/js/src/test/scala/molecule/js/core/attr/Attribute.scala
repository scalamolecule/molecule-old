...
object Attribute extends AsyncTestSuite {
  ...
  lazy val tests = Tests {
    ...
    test("Single cardinality-1 attribute - one entity") {
    ...
    test("Single cardinality-2 attribute - one entity") {
      implicit val conn = Conn_Js.inMem(CoreTestSchema)
      for {
    ...
    test("Single cardinality-1 attribute - multiple entities") {
      implicit val conn = Conn_Js.inMem(CoreTestSchema)
      for {
    ...
    test("Single cardinality-2 attribute - multiple entities") {
      implicit val conn = Conn_Js.inMem(CoreTestSchema)
      for {
    ...
    test("Multiple cardinality-1 attributes - one entity") {
      implicit val conn = Conn_Js.inMem(CoreTestSchema)
      for {
    ...
    test("Multiple cardinality-2 attributes - one entity") {
      implicit val conn = Conn_Js.inMem(CoreTestSchema)
      for {
    ...
    test("Multiple cardinality-1 attributes - multiple entities") {
      implicit val conn = Conn_Js.inMem(CoreTestSchema)
      for {
    ...
    test("Multiple cardinality-2 attributes - multiple entities") {
      implicit val conn = Conn_Js.inMem(CoreTestSchema)
      for {
    ...
    test("Mixed cardinality attributes - one entity") {
      implicit val conn = Conn_Js.inMem(CoreTestSchema)
      for {
    ...
    test("Mixed cardinality attributes - multiple entities") {
      implicit val conn = Conn_Js.inMem(CoreTestSchema)
      for {
