...
import molecule.core.marshalling.{Conn_Js, DbException}
...
class AdHocTestJs2(implicit ee: ExecutionEnv) extends Specification
...
//      val asyncThing = Future(1) // calls test subject
////      asyncThing must beEqualTo("some value").awaitFor(10.seconds)
//
//      for{
//        _ <- asyncThing.map(_ must beEqualTo(2))
//      } yield ()
//      ok
//    }
//  }
