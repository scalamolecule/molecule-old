...
object NestedAttrs extends AsyncTestSuite {
  ...
  lazy val tests = Tests {
    ...
    "card 1" - {
      ...
      "attr" - core { implicit conn =>
        for {
          ...
          _ <- m(Ns.int.Refs1 * Ref1.int1.str1$).get === List(
            (1, List((1, Some("a")), (2, None)))
          )
          _ <- m(Ns.int.Refs1 * Ref1.int1.str1).get === List(
            (1, List((1, "a")))
          )
          _ <- m(Ns.int.Refs1 * Ref1.int1.str1_).get === List(
            (1, List(1))
          )
      ...
      "enum" - core { implicit conn =>
        for {
          ...
          _ <- m(Ns.int.Refs1 * Ref1.int1.enum1$).get === List(
            (1, List((1, Some("enum10")), (2, None)))
          )
          _ <- m(Ns.int.Refs1 * Ref1.int1.enum1).get === List(
            (1, List((1, "enum10")))
          )
          _ <- m(Ns.int.Refs1 * Ref1.int1.enum1_).get === List(
            (1, List(1))
          )
      ...
      "ref" - core { implicit conn =>
        for {
          ...
          _ <- m(Ns.int.Refs1 * Ref1.int1.ref2$).get === List(
            (1, List((1, Some(42L)), (2, None)))
          )
          _ <- m(Ns.int.Refs1 * Ref1.int1.ref2).get === List(
            (1, List((1, 42L)))
          )
          _ <- m(Ns.int.Refs1 * Ref1.int1.ref2_).get === List(
            (1, List(1))
          )
    ...
    "card 2" - {
      ...
      "attr" - core { implicit conn =>
        for {
          ...
          _ <- m(Ns.int.Refs1 * Ref1.int1.strs1$).get === List(
            (1, List((1, Some(Set("a", "b"))), (2, None))),
          )
          _ <- m(Ns.int.Refs1 * Ref1.int1.strs1).get === List(
            (1, List((1, Set("a", "b")))),
          )
          _ <- m(Ns.int.Refs1 * Ref1.int1.strs1_).get === List(
            (1, List(1)),
          )
      ...
      "enum" - core { implicit conn =>
        for {
          ...
          _ <- m(Ns.int.Refs1 * Ref1.int1.enums1$).get === List(
            (1, List((1, Some(Set("enum10", "enum11"))), (2, None)))
          )
          _ <- m(Ns.int.Refs1 * Ref1.int1.enums1).get === List(
            (1, List((1, Set("enum10", "enum11"))))
          )
          _ <- m(Ns.int.Refs1 * Ref1.int1.enums1_).get === List(
            (1, List(1))
          )
      ...
      "ref" - core { implicit conn =>
        for {
          ...
          _ <- m(Ns.int.Refs1 * Ref1.int1.refs2$).get === List(
            (1, List((1, Some(Set(42L, 43L))), (2, None)))
          )
          _ <- m(Ns.int.Refs1 * Ref1.int1.refs2).get === List(
            (1, List((1, Set(42L, 43L))))
          )
          _ <- m(Ns.int.Refs1 * Ref1.int1.refs2_).get === List(
            (1, List(1))
          )
    ...
    "card 3 (map)" - core { implicit conn =>
      for {
        ...
        _ <- m(Ns.int.Refs1 * Ref1.int1.intMap1$).get === List(
          (1, List((1, Some(Map("a" -> 1, "b" -> 2))), (2, None))),
        )
        _ <- m(Ns.int.Refs1 * Ref1.int1.intMap1).get === List(
          (1, List((1, Map("a" -> 1, "b" -> 2)))),
        )
        _ <- m(Ns.int.Refs1 * Ref1.int1.intMap1_).get === List(
          (1, List(1)),
        )
