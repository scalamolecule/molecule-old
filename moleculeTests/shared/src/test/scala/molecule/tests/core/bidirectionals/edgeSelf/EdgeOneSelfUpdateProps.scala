    ...
    "Card-one" - {
      ...
      "value" - bidirectional { implicit conn =>
        for {
          ...
          _ <- Person.name("Ann" or "Ben").Loves.weight.get === List()
        } yield ()
      }
      ...
      "enum" - bidirectional { implicit conn =>
        for {
          ...
          _ <- Person.name("Ann" or "Ben").Loves.howWeMet.get === List()
        } yield ()
      }
      ...
      "ref" - bidirectional { implicit conn =>
        for {
          ...
          _ <- Loves(annBen).CoreQuality.name.get === List()
        } yield ()
      }
    }
    ...
    "Card-many" - {
      ...
      "enums" - bidirectional { implicit conn =>
        ...
        for {
          ...
          _ <- commonLicencesOf("Ann" or "Ben").get === List()
        } yield ()
      }
