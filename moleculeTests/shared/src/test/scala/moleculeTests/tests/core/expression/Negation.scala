  ...
  lazy val tests = Tests {
    ...
    "Card one" - core { implicit conn =>
      for {
        ...
        _ <- Ns.str.not("").a1.get.map(_ ==> List(" ", ",", ".", "?", "A", "B", "a", "b"))
        _ <- Ns.str.not(" ").a1.get.map(_ ==> List("", ",", ".", "?", "A", "B", "a", "b"))
        _ <- Ns.str.not(",").a1.get.map(_ ==> List("", " ", ".", "?", "A", "B", "a", "b"))
        _ <- Ns.str.not(".").a1.get.map(_ ==> List("", " ", ",", "?", "A", "B", "a", "b"))
        _ <- Ns.str.not("?").a1.get.map(_ ==> List("", " ", ",", ".", "A", "B", "a", "b"))
        _ <- Ns.str.not("A").a1.get.map(_ ==> List("", " ", ",", ".", "?", "B", "a", "b"))
        _ <- Ns.str.not("B").a1.get.map(_ ==> List("", " ", ",", ".", "?", "A", "a", "b"))
        _ <- Ns.str.not("a").a1.get.map(_ ==> List("", " ", ",", ".", "?", "A", "B", "b"))
        _ <- Ns.str.not("b").a1.get.map(_ ==> List("", " ", ",", ".", "?", "A", "B", "a"))
        _ <- Ns.str.not("C").a1.get.map(_ ==> List("", " ", ",", ".", "?", "A", "B", "a", "b"))
        _ <- Ns.str.not("c").a1.get.map(_ ==> List("", " ", ",", ".", "?", "A", "B", "a", "b"))

        _ <- Ns.str.not(str1).a1.get.map(_ ==> List("", " ", ",", ".", "?", "A", "B", "b"))

        // Negate multiple values ("NOR"-logic: not 'a NOR 'b NOR 'c...)
        _ <- Ns.str.not("", " ").a1.get.map(_ ==> List(",", ".", "?", "A", "B", "a", "b"))
        _ <- Ns.str.not("", " ", ",", ".", "?").a1.get.map(_ ==> List("A", "B", "a", "b"))
        _ <- Ns.str.not("", " ", ",", ".", "?", "A", "B").a1.get.map(_ ==> List("a", "b"))
        _ <- Ns.str.not("", " ", ",", ".", "?", "A", "B", "a", "b").a1.get.map(_ ==> List())


        _ <- Ns.int.not(7).a1.get.map(_ ==> List(-2, -1, 0, 1, 2))
        _ <- Ns.int.not(1).a1.get.map(_ ==> List(-2, -1, 0, 2))
        _ <- Ns.int.not(-1, 0, 1).a1.get.map(_ ==> List(-2, 2))
        _ <- Ns.int.not(Seq(-1, 0, 1)).a1.get.map(_ ==> List(-2, 2))
        _ <- Ns.int.not(int1).a1.get.map(_ ==> List(-2, -1, 0, 2))
        _ <- Ns.int.not(int1, int2).a1.get.map(_ ==> List(-2, -1, 0))
        _ <- Ns.int.not(Seq(int1, int2)).a1.get.map(_ ==> List(-2, -1, 0))
        ints = Seq(int1, int2)
        _ <- Ns.int.not(ints).a1.get.map(_ ==> List(-2, -1, 0))

        _ <- Ns.long.not(7L).a1.get.map(_ ==> List(-2L, -1L, 0L, 1L, 2L))
        _ <- Ns.long.not(1L).a1.get.map(_ ==> List(-2L, -1L, 0L, 2L))
        _ <- Ns.long.not(-1L, 0L, 1L).a1.get.map(_ ==> List(-2L, 2L))
        _ <- Ns.long.not(Seq(-1L, 0L, 1L)).a1.get.map(_ ==> List(-2L, 2L))
        _ <- Ns.long.not(long1).a1.get.map(_ ==> List(-2L, -1L, 0L, 2L))
        _ <- Ns.long.not(long1, long1).a1.get.map(_ ==> List(-2L, -1L, 0L, 2L))
        _ <- Ns.long.not(Seq(long1, long2)).a1.get.map(_ ==> List(-2L, -1L, 0L))
        longs = Seq(long1, long2)
        _ <- Ns.long.not(longs).a1.get.map(_ ==> List(-2L, -1L, 0L))


        _ <- Ns.double.not(7.0).a1.get.map(_ ==> List(-2.0, -1.0, 0.0, 1.0, 2.0))
        _ <- Ns.double.not(1.0).a1.get.map(_ ==> List(-2.0, -1.0, 0.0, 2.0))
        _ <- Ns.double.not(-1.0, 0.0, 1.0).a1.get.map(_ ==> List(-2.0, 2.0))
        _ <- Ns.double.not(Seq(-1.0, 0.0, 1.0)).a1.get.map(_ ==> List(-2.0, 2.0))
        _ <- Ns.double.not(double1).a1.get.map(_ ==> List(-2.0, -1.0, 0.0, 2.0))
        _ <- Ns.double.not(double1, double2).a1.get.map(_ ==> List(-2.0, -1.0, 0.0))
        _ <- Ns.double.not(Seq(double1, double2)).a1.get.map(_ ==> List(-2.0, -1.0, 0.0))
        doubles = Seq(double1, double2)
        _ <- Ns.double.not(doubles).a1.get.map(_ ==> List(-2.0, -1.0, 0.0))
        ...
        _ <- Ns.date.not(date3).a1.get.map(_ ==> List(date0, date1, date2))
        _ <- Ns.date.not(date0).a1.get.map(_ ==> List(date1, date2))
        _ <- Ns.date.not(date0, date1).a1.get.map(_ ==> List(date2))
        _ <- Ns.date.not(Seq(date0, date1)).a1.get.map(_ ==> List(date2))
        dates = Seq(date0, date1)
        _ <- Ns.date.not(dates).a1.get.map(_ ==> List(date2))


        _ <- Ns.uuid.not(uuid3).a1.get.map(_ ==> List(uuid0, uuid1, uuid2))
        _ <- Ns.uuid.not(uuid0).a1.get.map(_ ==> List(uuid1, uuid2))
        _ <- Ns.uuid.not(uuid0, uuid1).a1.get.map(_ ==> List(uuid2))
        _ <- Ns.uuid.not(Seq(uuid0, uuid1)).a1.get.map(_ ==> List(uuid2))
        uuids = Seq(uuid0, uuid1)
        _ <- Ns.uuid.not(uuids).a1.get.map(_ ==> List(uuid2))


        _ <- Ns.uri.not(uri3).a1.get.map(_ ==> List(uri0, uri1, uri2))
        _ <- Ns.uri.not(uri0).a1.get.map(_ ==> List(uri1, uri2))
        _ <- Ns.uri.not(uri0, uri1).a1.get.map(_ ==> List(uri2))
        _ <- Ns.uri.not(Seq(uri0, uri1)).a1.get.map(_ ==> List(uri2))
        uris = Seq(uri0, uri1)
        _ <- Ns.uri.not(uris).a1.get.map(_ ==> List(uri2))


        _ <- Ns.enumm.not("enum0").a1.get.map(_ ==> List(enum1, enum2))
        _ <- Ns.enumm.not("enum0", "enum1").a1.get.map(_ ==> List(enum2))
        _ <- Ns.enumm.not(Seq("enum0", "enum1")).a1.get.map(_ ==> List(enum2))
        _ <- Ns.enumm.not(enum0).a1.get.map(_ ==> List(enum1, enum2))
        _ <- Ns.enumm.not(enum0, enum1).a1.get.map(_ ==> List(enum2))
        _ <- Ns.enumm.not(Seq(enum0, enum1)).a1.get.map(_ ==> List(enum2))
        enums = Seq(enum0, enum1)
        _ <- Ns.enumm.not(enums).a1.get.map(_ ==> List(enum2))


        _ <- Ns.bigInt.not(bigInt3).a1.get.map(_ ==> List(bigInt0, bigInt1, bigInt2))
        _ <- Ns.bigInt.not(bigInt0).a1.get.map(_ ==> List(bigInt1, bigInt2))
        _ <- Ns.bigInt.not(bigInt0, bigInt1).a1.get.map(_ ==> List(bigInt2))
        _ <- Ns.bigInt.not(Seq(bigInt0, bigInt1)).a1.get.map(_ ==> List(bigInt2))
        bigInts = Seq(bigInt0, bigInt1)
        _ <- Ns.bigInt.not(bigInts).a1.get.map(_ ==> List(bigInt2))


        _ <- Ns.bigDec.not(bigDec3).a1.get.map(_ ==> List(bigDec0, bigDec1, bigDec2))
        _ <- Ns.bigDec.not(bigDec0).a1.get.map(_ ==> List(bigDec1, bigDec2))
        _ <- Ns.bigDec.not(bigDec0, bigDec1).a1.get.map(_ ==> List(bigDec2))
        _ <- Ns.bigDec.not(Seq(bigDec0, bigDec1)).a1.get.map(_ ==> List(bigDec2))
        bigDecs = Seq(bigDec0, bigDec1)
        _ <- Ns.bigDec.not(bigDecs).a1.get.map(_ ==> List(bigDec2))
      } yield ()
    }
