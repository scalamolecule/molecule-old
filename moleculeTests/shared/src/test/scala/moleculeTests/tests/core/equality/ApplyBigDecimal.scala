  ...
  lazy val tests = Tests {
    ...
    "Card one" - {
      ...
      "Implicit widening conversions, card one" - core { implicit conn =>
        ...
        for {
          ...
          _ <- Ns.int.a1.bigDec(1).get.map(_ ==> res1)
          _ <- Ns.int.a1.bigDec(1L).get.map(_ ==> res1)
          _ <- Ns.int.a1.bigDec(1f).get.map(_ ==> res1)
          _ <- Ns.int.a1.bigDec(1.0).get.map(_ ==> res1)

          _ <- Ns.int.a1.bigDec(i1).get.map(_ ==> res1)
          _ <- Ns.int.a1.bigDec(d1).get.map(_ ==> res1)
          _ <- Ns.int.a1.bigDec(x1).get.map(_ ==> res1)
          _ <- Ns.int.a1.bigDec(y1).get.map(_ ==> res1)

          _ <- Ns.int.a1.bigDec.not(i2).get.map(_ ==> res1)
          _ <- Ns.int.a1.bigDec.<(i2).get.map(_ ==> res1)
          _ <- Ns.int.a1.bigDec.>(i1).get.map(_ ==> res2)
          _ <- Ns.int.a1.bigDec.>=(i2).get.map(_ ==> res2)
          _ <- Ns.int.a1.bigDec.<=(i1).get.map(_ ==> res1)

          _ <- Ns.int.a1.bigDec.not(2).get.map(_ ==> res1)
          _ <- Ns.int.a1.bigDec.<(2).get.map(_ ==> res1)
          _ <- Ns.int.a1.bigDec.>(1).get.map(_ ==> res2)
          _ <- Ns.int.a1.bigDec.>=(2).get.map(_ ==> res2)
          _ <- Ns.int.a1.bigDec.<=(1).get.map(_ ==> res1)


          _ <- Ns.int.a1.bigDec_(1).get.map(_ ==> res1t)
          _ <- Ns.int.a1.bigDec_(1L).get.map(_ ==> res1t)
          _ <- Ns.int.a1.bigDec_(1f).get.map(_ ==> res1t)
          _ <- Ns.int.a1.bigDec_(1.0).get.map(_ ==> res1t)

          _ <- Ns.int.a1.bigDec_(i1).get.map(_ ==> res1t)
          _ <- Ns.int.a1.bigDec_(d1).get.map(_ ==> res1t)
          _ <- Ns.int.a1.bigDec_(x1).get.map(_ ==> res1t)
          _ <- Ns.int.a1.bigDec_(y1).get.map(_ ==> res1t)

          _ <- Ns.int.a1.bigDec_.not(i2).get.map(_ ==> res1t)
          _ <- Ns.int.a1.bigDec_.<(i2).get.map(_ ==> res1t)
          _ <- Ns.int.a1.bigDec_.>(i1).get.map(_ ==> res2t)
          _ <- Ns.int.a1.bigDec_.>=(i2).get.map(_ ==> res2t)
          _ <- Ns.int.a1.bigDec_.<=(i1).get.map(_ ==> res1t)

          _ <- Ns.int.a1.bigDec_.not(2).get.map(_ ==> res1t)
          _ <- Ns.int.a1.bigDec_.<(2).get.map(_ ==> res1t)
          _ <- Ns.int.a1.bigDec_.>(1).get.map(_ ==> res2t)
          _ <- Ns.int.a1.bigDec_.>=(2).get.map(_ ==> res2t)
          _ <- Ns.int.a1.bigDec_.<=(1).get.map(_ ==> res1t)
        } yield ()
      }
    }
    ...
    "Implicit widening conversions, card many" - core { implicit conn =>
      ...
      for {
        ...
        _ <- Ns.int.a1.bigDecs(1).get.map(_ ==> res1)
        _ <- Ns.int.a1.bigDecs(1L).get.map(_ ==> res1)
        _ <- Ns.int.a1.bigDecs(1f).get.map(_ ==> res1)
        _ <- Ns.int.a1.bigDecs(1.0).get.map(_ ==> res1)

        _ <- Ns.int.a1.bigDecs(i1).get.map(_ ==> res1)
        _ <- Ns.int.a1.bigDecs(d1).get.map(_ ==> res1)
        _ <- Ns.int.a1.bigDecs(x1).get.map(_ ==> res1)
        _ <- Ns.int.a1.bigDecs(y1).get.map(_ ==> res1)

        _ <- Ns.int.a1.bigDecs.not(i2).get.map(_ ==> res1)
        _ <- Ns.int.a1.bigDecs.<(i2).get.map(_ ==> res1)
        _ <- Ns.int.a1.bigDecs.>(i1).get.map(_ ==> res2)
        _ <- Ns.int.a1.bigDecs.>=(i2).get.map(_ ==> res2)
        _ <- Ns.int.a1.bigDecs.<=(i1).get.map(_ ==> res1)

        _ <- Ns.int.a1.bigDecs.not(2).get.map(_ ==> res1)
        _ <- Ns.int.a1.bigDecs.<(2).get.map(_ ==> res1)
        _ <- Ns.int.a1.bigDecs.>(1).get.map(_ ==> res2)
        _ <- Ns.int.a1.bigDecs.>=(2).get.map(_ ==> res2)
        _ <- Ns.int.a1.bigDecs.<=(1).get.map(_ ==> res1)


        _ <- Ns.int.a1.bigDecs_(1).get.map(_ ==> res1t)
        _ <- Ns.int.a1.bigDecs_(1L).get.map(_ ==> res1t)
        _ <- Ns.int.a1.bigDecs_(1f).get.map(_ ==> res1t)
        _ <- Ns.int.a1.bigDecs_(1.0).get.map(_ ==> res1t)

        _ <- Ns.int.a1.bigDecs_(i1).get.map(_ ==> res1t)
        _ <- Ns.int.a1.bigDecs_(d1).get.map(_ ==> res1t)
        _ <- Ns.int.a1.bigDecs_(x1).get.map(_ ==> res1t)
        _ <- Ns.int.a1.bigDecs_(y1).get.map(_ ==> res1t)

        _ <- Ns.int.a1.bigDecs_.not(i2).get.map(_ ==> res1t)
        _ <- Ns.int.a1.bigDecs_.<(i2).get.map(_ ==> res1t)
        _ <- Ns.int.a1.bigDecs_.>(i1).get.map(_ ==> res2t)
        _ <- Ns.int.a1.bigDecs_.>=(i2).get.map(_ ==> res2t)
        _ <- Ns.int.a1.bigDecs_.<=(i1).get.map(_ ==> res1t)

        _ <- Ns.int.a1.bigDecs_.not(2).get.map(_ ==> res1t)
        _ <- Ns.int.a1.bigDecs_.<(2).get.map(_ ==> res1t)
        _ <- Ns.int.a1.bigDecs_.>(1).get.map(_ ==> res2t)
        _ <- Ns.int.a1.bigDecs_.>=(2).get.map(_ ==> res2t)
        _ <- Ns.int.a1.bigDecs_.<=(1).get.map(_ ==> res1t)
      } yield ()
    }
  }
