...
//        _ <- Schema.t(t0, t1).a.inspectGet
//        _ <- Schema.t(Seq(t0, t1)).a.inspectGet
//        _ <- Schema.t.>(t1).a.inspectGet
//        _ <- Schema.t.>=(t1).a.inspectGet
//        _ <- Schema.t.<(t1).a.inspectGet
//        _ <- Schema.t.<=(t1).a.inspectGet
//        _ <- Schema.t.not(t1).a.inspectGet
//        _ <- Schema.t.not(t1, 42L).a.inspectGet
//        _ <- Schema.t.not(Seq(t1, 42L)).a.inspectGet
//        _ <- Schema.t.doc.contains("xxx").inspectGet
        //        _ <- Schema.t(t1).a.inspectGetHistory
        ...
        _ <- Schema.t.a(":Foo/str").getHistory.map(_ ==> List((t1, ":Foo/str")))
        _ <- Schema.t(t1).a(":Foo/str").getHistory.map(_ ==> List((t1, ":Foo/str")))
        ...
        _ <- Schema.t.not(t0).a.getHistory.map(_ ==> List((t1, ":Foo/str")))
        _ <- Schema.t.not(t0, t1).a.getHistory.map(_ ==> Nil)
        _ <- Schema.t.not(Seq(t0)).a.getHistory.map(_ ==> List((t1, ":Foo/str")))
        _ <- Schema.t.not(Seq(t0, t1)).a.getHistory.map(_ ==> Nil)
