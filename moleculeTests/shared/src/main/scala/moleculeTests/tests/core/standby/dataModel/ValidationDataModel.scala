package moleculeTests.tests.core.standby.dataModel

import molecule.core.data.model._

@InOut(3, 22)
object ValidationDataModel {

  trait StringValue {
    val mand      = oneString.mandatory.doc("Any use of this namespace must have a value asserted for this attribute")
//    val email     = oneString.email
//    val validate1 = oneString.validate(_.contains("abc"))
//    val validate2 = oneString.validate(s => s.contains("abc") && s.length > 4)
//    val validate3 = oneString.validate { s =>
//      s.contains("abc") && s.length > 4
//    }
//    val validate4 = oneString.validate {
//      case "a" | "b" => false
//      case s         => {
//        val email = "info@gmail.com"
//        s.contains(email) && s.length > 4
//      }
//    }
  }
  ...
  trait IntValue {
//    val min  = oneInt.min(1)
//    val max  = oneInt.max(1).doc("Negative Int or zero")
//    val pos  = oneInt.pos.doc("Positive Int")
//    val neg  = oneInt.neg.doc("Negative Int")
//    val pos0 = oneInt.pos0.doc("Zero or positive Int")
//    val neg0 = oneInt.neg0.doc("Zero or negative Int")
//
//    val xpos  = oneInt.validate(_ > 0).doc("Positive Int")
//    val xneg  = oneInt.validate(_ < 0).doc("Negative Int")
//    val xpos0 = oneInt.validate(_ >= 0).doc("Zero or positive Int")
//    val xneg0 = oneInt.validate(_ <= 0).doc("Zero or negative Int")
