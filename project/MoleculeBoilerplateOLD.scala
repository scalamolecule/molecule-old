...
//  }
//
//  case class Namespace(part: String, ns: String, opt: Option[Extension] = None, attrs: Seq[DefAttr] = Seq())
//
...
//                 bi: Option[String] = None, revRef: String = "") extends DefAttr
//
...
//                 bi: Option[String] = None, revRef: String = "") extends DefAttr
//
//  case class BackRef(attr: String, attrClean: String, clazz: String, clazz2: String, tpe: String, baseTpe: String, backRef: String, options: Seq[Optional] = Seq()) extends DefAttr
//
...
//  private def padI(n: Int) = if (n < 10) "0" + n else n
...
//  // Parse ..........................................
//
//  def parse(defFile: File, allIndexed: Boolean) = {
...
//
//    def parseAttr(backTics: Boolean, attrClean: String, str: String, curPart: String, curFullNs: String): Seq[DefAttr] = {
...
//
//        case r"oneEnum\((.*?)$enums\)(.*)$str"  => Seq(
//          Enum(attr, attrClean, "OneEnum", "String", "", enums.replaceAll("'", "").split(",").toList.map(_.trim), parseOptions(str, Nil, attr, curFullNs))
//        )
//        case r"manyEnum\((.*?)$enums\)(.*)$str" => Seq(
//          Enum(attr, attrClean, "ManyEnums", "Set[String]", "String", enums.replaceAll("'", "").split(",").toList.map(_.trim), parseOptions(str, Nil, attr, curFullNs))
//        )
//
//
