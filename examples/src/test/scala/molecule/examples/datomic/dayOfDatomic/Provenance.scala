package molecule.examples.datomic.dayOfDatomic

import molecule.core.ast.model._
import molecule.core.util.DatomicPeerServer
import molecule.datomic.api.out7._
import molecule.examples.datomic.dayOfDatomic.dsl.socialNews._
import molecule.ExampleSpec
import scala.language.reflectiveCalls


class Provenance extends ExampleSpec {
  ...
  "Transaction meta data" in new SocialNewsSetup {
    ...
    // Time of transaction
    val stuTxInstant = stuTxId.apply[java.util.Date](":db/txInstant").get
