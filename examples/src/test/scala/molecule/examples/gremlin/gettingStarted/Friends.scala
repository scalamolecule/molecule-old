...
import molecule.examples.gremlin.gettingStarted.dsl.modernGraph1._
...
class Friends extends ExampleSpec {

  class BidirectionalSelfRefSetup extends ModernGraph1Setup {
