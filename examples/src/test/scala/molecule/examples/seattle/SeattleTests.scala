...
//    m(Community.name < "C").debug
  ...
  "Manipulating data - insert" >> {
    ...
    Community.name.url.insert(Seq(("Com A", "A.com"), ("Com B", "B.com"))).ids === Seq(17592186045902L, 17592186045903L)

    // Data as list of HLists
    Community.name.url.insert(Seq("Com C" :: "C.com" :: HNil, "Com D" :: "D.com" :: HNil)).ids === Seq(17592186045905L, 17592186045906L)
    ...
    insertCommunity(newCommunitiesData).ids === List(17592186045909L, 17592186045910L, 17592186045912L, 17592186045913L, 17592186045915L, 17592186045916L)
  ...
  "Manipulating data - update/retract" >> {
    ...
    // Values before
    //    Community.name("belltown 2").name.`type`.url.category.hl === List(
