...
import molecule.examples.datomic.dayOfDatomic.SocialNewsData
import molecule.examples.datomic.mbrainz.schema.{MBrainzSchema, MBrainzSchemaLowerToUpper}
import molecule.examples.datomic.seattle.SeattleData
