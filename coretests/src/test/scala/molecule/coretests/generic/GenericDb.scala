...
//
//      // eq
//      Schema.ns("db").get === List("db")
//
//      // eq multiple
//      Schema.ns("db", "fressian").get.sorted === List("db", "fressian")
//
//      // neq
//      Schema.ns.not("db").get.sorted === List(
//        // "db",
//        "db.alter",
//        "db.excise",
//        "db.install",
...
//
//      // neq multiple
//      Schema.ns.not("db", "fressian").get.sorted === List(
//        // "db",
//        "db.alter",
//        "db.excise",
//        "db.install",
