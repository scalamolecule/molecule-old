...
//
//
//class GenericDbQuery extends CoreSpec {
//
//  sequential
//
...
//
//      // eq multiple
//      Schema.ns("db", "fressian")._query.debug ===
//        """[:find  ?b2
//          | :in    $ %
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
...
//
//      // neq
//      Schema.ns.not("db")._query.datalog ===
//        """[:find  ?b2
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(.getNamespace ^clojure.lang.Keyword ?b1) ?b2]
...
//
//      // neq multiple
//      Schema.ns.not("db", "fressian")._query.datalog ===
//        """[:find  ?b2
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(.getNamespace ^clojure.lang.Keyword ?b1) ?b2]
//          |        [(!= ?b2 "db")]
//          |        [(!= ?b2 "fressian")]]""".stripMargin
//    }
//
//
//    "tacit" >> {
//
//      // eq
//      Schema.ns_("db.install").a._query.datalog ===
//        """[:find  ?c2
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(.getNamespace ^clojure.lang.Keyword ?b1) ?b2]
...
//
//      // + count
//      Schema.ns_("db.install").a(count)._query.datalog ===
//        """[:find  (count ?c2)
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(.getNamespace ^clojure.lang.Keyword ?b1) ?b2]
...
//
//      // eq multiple
//      Schema.ns("db.install", "fressian")._query.debug ===
//        """[:find  ?b2
//          | :in    $ %
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
...
//
//      // neq
//      Schema.ns_.not("db").a._query.datalog ===
//        """[:find  ?c2
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(.getNamespace ^clojure.lang.Keyword ?b1) ?b2]
...
//
//      // neq multiple
//      Schema.ns_.not("db", "ns").a._query.datalog ===
//        """[:find  ?c2
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(.getNamespace ^clojure.lang.Keyword ?b1) ?b2]
...
//    "mandatory" >> {
//
//      Schema.a._query.datalog ===
//        """[:find  ?b2
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(name ?b1) ?b2]]""".stripMargin
//
//      Schema.a(count)._query.datalog ===
//        """[:find  (count ?b2)
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(name ?b1) ?b2]]""".stripMargin
//
//      Schema.ns.a._query.datalog ===
//        """[:find  ?b2 ?c2
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(.getNamespace ^clojure.lang.Keyword ?b1) ?b2]
...
//          |        [(= ?b2 "lang")]]""".stripMargin
//
//      Schema.ns.a("lang")._query.datalog ===
//        """[:find  ?b2 ?c2
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(.getNamespace ^clojure.lang.Keyword ?b1) ?b2]
...
//
//      // eq multiple
//      Schema.a("lang", "txInstant")._query.debug ===
//        """[:find  ?b2
//          | :in    $ %
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
...
//          |""".stripMargin
//
//      Schema.ns.a("lang", "txInstant")._query.debug ===
//        """[:find  ?b2 ?c2
//          | :in    $ %
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
...
//
//      // neq
//      Schema.a.not("attribute")._query.datalog ===
//        """[:find  ?b2
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(name ?b1) ?b2]
...
//
//      // neq multiple
//      Schema.a.not("attribute", "attrs")._query.datalog ===
//        """[:find  ?b2
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(name ?b1) ?b2]
...
//
//      // eq
//      Schema.ns.a_("lang")._query.datalog ===
//        """[:find  ?b2
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(.getNamespace ^clojure.lang.Keyword ?b1) ?b2]
...
//
//      // eq multiple
//      Schema.ns.a_("lang", "tag")._query.debug ===
//        """[:find  ?b2
//          | :in    $ %
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
...
//
//      // neq
//      Schema.ns.a_.not("tag")._query.datalog ===
//        """[:find  ?b2
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(.getNamespace ^clojure.lang.Keyword ?b1) ?b2]
...
//
//      // neq multiple
//      Schema.ns.a_.not("lang", "tag")._query.datalog ===
//        """[:find  ?b2
//          | :where [:db.part/db :db.install/attribute ?b]
//          |        [?b :db/ident ?b1]
//          |        [(.getNamespace ^clojure.lang.Keyword ?b1) ?b2]
...
//    //    Schema.e.a.v.get.sortBy(r => (r._1, r._2, r._3.toString)).map { case (e, a, v) =>
