...
class Logic extends Base {
  ...
  "Card one - OR" in new OneSetup {
    ...
    Ns.bigInt(bigInt1, bigInt2).get.sortBy(_.toString) === List(bigInt1, bigInt2)
    Ns.bigInt(bigInt1 or bigInt2).get.sortBy(_.toString) === List(bigInt1, bigInt2)
    Ns.bigInt(List(bigInt1, bigInt2)).get.sortBy(_.toString) === List(bigInt1, bigInt2)
    val bigIntList = List(bigInt1, bigInt2)
    Ns.bigInt(bigIntList).get.sortBy(_.toString) === List(bigInt1, bigInt2)


    Ns.bigDec(bigDec1, bigDec2).get.sortBy(_.toString) === List(bigDec1, bigDec2)
    Ns.bigDec(bigDec1 or bigDec2).get.sortBy(_.toString) === List(bigDec1, bigDec2)
    Ns.bigDec(List(bigDec1, bigDec2)).get.sortBy(_.toString) === List(bigDec1, bigDec2)
    val bigDecList = List(bigDec1, bigDec2)
    Ns.bigDec(bigDecList).get.sortBy(_.toString) === List(bigDec1, bigDec2)
